...
case "$(uname -m)" in
	arm64) ODIN_ARCHIVE=$ODIN_MACOS_ARM64_ARCHIVE; ODIN_SHA256=$ODIN_MACOS_ARM64_SHA256 ;;
	x86_64) ODIN_ARCHIVE=$ODIN_MACOS_AMD64_ARCHIVE; ODIN_SHA256=$ODIN_MACOS_AMD64_SHA256 ;;
