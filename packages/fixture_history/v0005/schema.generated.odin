...
// fixture-history-schema-version: 5
// fixture-history-manifest-sha256: 85bc521bfd104574d88204d6522be2aa05e935241516a92dea91be75c8a3d012
package fixture_v0005
...
History_Type_0004 :: struct {
    structures:   [dynamic]History_Type_0093,
    count:        int,
...
History_Type_0020 :: struct {
    pose:                     History_Type_0096,
    base_pose:                History_Type_0096,
    orbit_yaw:                f32,
    orbit_pitch:              f32,
    focal_length:             f32,
    shake_phase:              f32,
...
History_Type_0041 :: struct {
    ...
    style:                     History_Type_0037,
    boundary_form:             History_Type_0039,
    shoreline_form:            History_Type_0047,
    section_form_counts:       [9]int,
    cells:                     [567]History_Type_0040,
    segments:                  [96]History_Type_0045,
    segment_count:             int,
    slips:                     [40]History_Type_0048,
    slip_count:                int,
    props:                     [48]History_Type_0042,
    prop_count:                int,
    route:                     History_Type_0044,
    office:                    History_Type_0049,
    world_conditioned:         bool,
    world_origin:              History_Type_0049,
    world_yaw:                 f32,
    spacing_density:           f32,
...
History_Type_0042 :: struct {
    kind:     History_Type_0043,
    position: History_Type_0049,
    yaw:      f32,
}

// fixture-history-id: adriatic:packages/marina.Prop_Kind
History_Type_0043 :: enum u8 {
    Lamp    = 0,
    Beacon  = 1,
    Bollard = 2,
    Crates  = 3,
...
History_Type_0062 :: struct {
    ...
    flight_model:             History_Type_0059,
    ...
    last_landing:             History_Type_0060,
    landing_feedback_seconds: f32,
    landing_intent_seconds:   f32,
    landing_intent:           bool,
    spawn_position:           History_Type_0034,
    spawn_orientation:        quaternion128,
    tuning:                   History_Type_0063,
}
...
History_Type_0067 :: struct {
    from:           int,
    to:             int,
    control_from:   History_Type_0071,
    control_to:     History_Type_0071,
    half_width:     f32,
    shoulder_width: f32,
    pavement:       History_Type_0070,
}

// fixture-history-id: adriatic:packages/roads.Graph
History_Type_0068 :: struct {
    nodes:      [64]History_Type_0069,
    node_count: int,
    edges:      [128]History_Type_0067,
    edge_count: int,
}

// fixture-history-id: adriatic:packages/roads.Node
History_Type_0069 :: struct {
    position:        History_Type_0071,
    up:              History_Type_0071,
    junction_radius: f32,
}
...
History_Type_0077 :: struct {
    active:      bool,
    kind:        History_Type_0078,
    from:        History_Type_0081,
    to:          History_Type_0081,
    origin:      History_Type_0079,
    destination: History_Type_0079,
    subject:     string,
}
...
History_Type_0083 :: struct {
    quest:                History_Type_0065,
    romance:              History_Type_0082,
    repair:               History_Type_0080,
    airfield_errand:      History_Type_0076,
    delivery:             History_Type_0077,
    ...
    tarot_layout:         History_Type_0085,
    clinic_visits:        int,
    resident_action_seen: [History_Type_0081]u64,
}

// fixture-history-id: adriatic:packages/tarot.Card
History_Type_0084 :: distinct u8

// fixture-history-id: adriatic:packages/tarot.Layout
History_Type_0085 :: struct {
    spread:     History_Type_0088,
    placements: [10]History_Type_0087,
    count:      int,
    seed:       u32,
}
...
History_Type_0087 :: struct {
    card:        History_Type_0084,
    orientation: History_Type_0086,
    position:    string,
}
...
History_Type_0092 :: struct {
    levels:                [6]History_Type_0089,
    sea_level:             f32,
    revision:              u64,
    structures:            [dynamic]History_Type_0093,
    structure_count:       int,
    next_structure_id:     u64,
    road_graph:            History_Type_0068,
...
History_Type_0093 :: struct {
    ...
    rotation:      f32,
    color:         [4]u8,
    kind:          History_Type_0091,
    entrance_side: History_Type_0090,
    seed:          u32,
    building:      History_Type_0016,
}

// fixture-history-id: adriatic:packages/terrain.Tool
History_Type_0094 :: enum int {
    Raise     = 0,
    Smooth    = 1,
    Paint     = 2,
    Structure = 3,
...
History_Type_0096 :: struct {
    position: History_Type_0101,
    target:   History_Type_0101,
}
...
History_Type_0100 :: struct {
    position:           History_Type_0101,
    velocity:           History_Type_0101,
    facing_yaw_radians: f32,
    grounded:           bool,
    turn_amount:        f32,
    brake_amount:       f32,
    ground_normal:      History_Type_0101,
    running:            bool,
    drifting:           bool,
    drift_charge:       f32,
    boost_seconds:      f32,
...
History_Type_0107 :: struct {
    velocity:       History_Type_0101,
    yaw_rate:       f32,
    reaction_force: History_Type_0101,
    body_roll:      f32,
    body_pitch:     f32,
    wheel_rotation: f32,
}
...
History_Type_0113 :: struct {
    editor_camera:      History_Type_0095,
    editor_focus:       History_Type_0101,
    player_camera:      History_Type_0095,
...
Fixture :: struct {
    project:                                History_Type_0092,
    authoring_tool:                         History_Type_0112,
    editor_ui:                              History_Type_0115,
    tool:                                   History_Type_0094,
    radius:                                 f32,
    strength:                               f32,
    hardness:                               f32,
    structure_selected:                     int,
    structure_kind:                         History_Type_0091,
    ...
    road_pavement:                          History_Type_0070,
    in_map:                                 bool,
    player:                                 History_Type_0100,
    ...
    camera:                                 History_Type_0095,
    camera_pose:                            History_Type_0096,
    cameras:                                History_Type_0098,
    flight_camera:                          History_Type_0020,
    editor_camera:                          History_Type_0095,
    editor_focus:                           History_Type_0101,
    boat_traffic:                           History_Type_0012,
    marina_dinghy_borrowed:                 bool,
    occupant:                               History_Type_0109,
    pilot:                                  History_Type_0108,
    car:                                    History_Type_0111,
    car_drive:                              History_Type_0105,
    car_trailer:                            History_Type_0107,
    car_trailer_attached:                   bool,
    car_trailer_position:                   History_Type_0101,
    car_trailer_yaw:                        f32,
    postale:                                History_Type_0062,
    libellula:                              History_Type_0035,
    rondine:                                History_Type_0072,
    aircraft:                               History_Type_0102,
    ...
    settlement_plan:                        History_Type_0145,
    ...
    vehicle_paint_tool:                     History_Type_0162,
    ...
    attendant_position:                     History_Type_0101,
    gerta_position:                         History_Type_0101,
    story_state:                            History_Type_0083,
    tracked_quest_node:                     History_Type_0064,
    ...
    tweak:                                  History_Type_0161,
    mouse_fur:                              History_Type_0124,
    mouse_pattern:                          History_Type_0125,
    mouse_headgear:                         History_Type_0123,
    mouse_scarf_enabled:                    bool,
    mouse_scarf_color:                      History_Type_0167,
...
History_Type_0128 :: struct {
    ...
    vehicle_seed: u32,
    wing_seed:    u32,
    cpu:          History_Type_0126,
    vehicle:      History_Type_0129,
    wing:         History_Type_0130,
    gpu:          History_Type_0127,
}
...
History_Type_0143 :: struct {
    route_length:          History_Type_0153,
    route_width:           History_Type_0153,
    route_grade:           History_Type_0153,
    route_length_by_class: [8]History_Type_0153,
    route_width_by_class:  [8]History_Type_0153,
    intersection_spacing:  History_Type_0153,
    dead_end_frontage:     History_Type_0153,
    block_short_side:      History_Type_0153,
    block_long_side:       History_Type_0153,
    block_area:            History_Type_0153,
    block_aspect:          History_Type_0153,
    block_irregularity:    History_Type_0153,
    parcel_frontage:       History_Type_0153,
    parcel_depth:          History_Type_0153,
    building_height:       History_Type_0153,
    building_footprint:    History_Type_0153,
    building_floors:       History_Type_0153,
    network_density:       f32,
    road_badness:          f32,
    attached_share:        f32,
...
History_Type_0145 :: struct {
    request:                      History_Type_0150,
    brush_pieces:                 [64]History_Type_0137,
    brush_piece_count:            int,
    next_brush_component_id:      u32,
    program:                      History_Type_0147,
    activity_points:              [512]History_Type_0135,
    activity_point_count:         int,
    inhabitants:                  [256]History_Type_0141,
    inhabitant_count:             int,
    village_reason:               History_Type_0164,
    neighborhoods:                [96]History_Type_0144,
    neighborhood_count:           int,
    macro_cells:                  [192]History_Type_0144,
    macro_cell_count:             int,
    routes:                       [320]History_Type_0146,
    ...
    blocks:                       [128]History_Type_0136,
    block_count:                  int,
    sites:                        [256]History_Type_0155,
    site_piece_ids:               [256]u32,
    site_count:                   int,
    rejected_sites:               [32]History_Type_0155,
    rejected_site_count:          int,
    decorative_foliage:           [32]History_Type_0093,
    decorative_foliage_count:     int,
    terrain_edits:                [192]History_Type_0157,
    terrain_edit_count:           int,
    ordinary_purposes:            [256]History_Type_0140,
    ordinary_purpose_count:       int,
    metrics:                      History_Type_0143,
    acceptance_failure:           History_Type_0133,
    valid:                        bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0146 :: struct {
    geometry:      History_Type_0151,
    class:         History_Type_0152,
    width:         f32,
    shoulder:      f32,
    pavement:      History_Type_0070,
    required:      bool,
...
History_Type_0147 :: struct {
    ordinary:             History_Type_0148,
    purposes:             [8]History_Type_0148,
    landmarks:            History_Type_0148,
    plazas:               History_Type_0148,
    parks:                History_Type_0148,
    vegetation:           History_Type_0148,
    residents:            History_Type_0148,
    workers:              History_Type_0148,
...
History_Type_0150 :: struct {
    region:  History_Type_0149,
    scale:   History_Type_0154,
    seed:    u32,
    center:  [2]f32,
    radius:  f32,
    density: f32,
...
History_Type_0155 :: struct {
    ...
    attached:      bool,
    accepted:      bool,
    landmark_kind: History_Type_0142,
    purpose:       History_Type_0140,
}
...
History_Type_0161 :: struct {
    terrain:          History_Type_0160,
    atmosphere:       History_Type_0005,
    player:           History_Type_0099,
    player_animation: History_Type_0131,
    player_tail:      History_Type_0050,
    camera:           History_Type_0113,
    world:            History_Type_0165,
    particles:        History_Type_0128,
    car:              History_Type_0106,
    car_vehicle:      History_Type_0163,
    postale_airframe: History_Type_0028,
    postale_runtime:  History_Type_0031,
    postale_tuning:   History_Type_0063,
    postale_vehicle:  History_Type_0163,
    presentation:     History_Type_0132,
}
...
History_Type_0166 :: struct {
    cells:              [31]History_Type_0119,
    seed:               u32,
    form:               History_Type_0120,
    break_index:        int,
    second_break_index: int,
    part_count:         int,
    first_bay:          int,
    last_bay:           int,
    parts:              [3]History_Type_0121,
    quality:            History_Type_0122,
    origin_x:           f32,
    origin_z:           f32,
    yaw:                f32,
    scale:              f32,
...
History_Type_0167 :: History_Type_0168
