...
// fixture-history-schema-version: 10
// fixture-history-manifest-sha256: 1cd934616fa922832b7d20b1095184fd376e8704b4bbebad53399ac2dac7512a
package fixture_v0010
...
History_Type_0004 :: struct {
    structures:   [dynamic]History_Type_0121,
    count:        int,
...
History_Type_0005 :: struct {
    ...
    lunar_days:    f32,
    front_seconds: f32,
    weather:       History_Type_0007,
    override:      History_Type_0006,
    paused:        bool,
}

// fixture-history-id: adriatic:packages/atmosphere.Weather_Preset
History_Type_0006 :: enum int {
    Automatic = 0,
    Clear     = 1,
    Windy     = 2,
    Storm     = 3,
...
History_Type_0008 :: struct {
    class:            History_Type_0010,
    position:         History_Type_0013,
    velocity:         History_Type_0013,
    yaw:              f32,
    speed:            f32,
    throttle:         f32,
    behavior:         History_Type_0009,
    route:            [8]History_Type_0013,
    route_count:      int,
    route_index:      int,
    schedule:         [5]History_Type_0011,
    schedule_count:   int,
    loiter_center:    History_Type_0013,
    loiter_radius:    f32,
    loiter_phase:     f32,
    mooring_position: History_Type_0013,
    mooring_yaw:      f32,
    wake:             [48]History_Type_0014,
    wake_count:       int,
    wake_distance:    f32,
}
...
History_Type_0016 :: struct {
    archetype:     History_Type_0015,
    purpose:       History_Type_0018,
    region:        History_Type_0019,
    landmark_kind: History_Type_0017,
}
...
History_Type_0020 :: struct {
    pose:                     History_Type_0124,
    base_pose:                History_Type_0124,
    orbit_yaw:                f32,
    orbit_pitch:              f32,
    focal_length:             f32,
    shake_phase:              f32,
...
History_Type_0023 :: struct {
    seed:         u32,
    width:        int,
    height:       int,
    tradition:    History_Type_0024,
    parcels:      [24]History_Type_0022,
    parcel_count: int,
    garden_x:     int,
    garden_z:     int,
    garden_span:  int,
...
History_Type_0037 :: struct {
    position:         History_Type_0058,
    yaw:              f32,
    class:            History_Type_0010,
    kind:             History_Type_0038,
    occupied:         bool,
...
History_Type_0039 :: struct {
    minimum: History_Type_0058,
    maximum: History_Type_0058,
}
...
History_Type_0043 :: struct {
    ...
    valid:                   bool,
    downgraded:              bool,
    strategy:                History_Type_0048,
    program:                 History_Type_0045,
    site:                    History_Type_0047,
    phases:                  [5]History_Type_0049,
    phase_count:             int,
    waterfront_zones:        [12]History_Type_0060,
    waterfront_count:        int,
    runtime_plan:            History_Type_0044,
...
History_Type_0044 :: struct {
    ...
    archetype:             History_Type_0036,
    valid:                 bool,
    bounds:                History_Type_0039,
    origin:                History_Type_0058,
    tangent:               History_Type_0058,
    outward:               History_Type_0058,
    sea_level:             f32,
    shoreline:             History_Type_0041,
    navigable_water:       History_Type_0041,
    fairway:               History_Type_0041,
    turning_basin:         History_Type_0041,
    structures:            [24]History_Type_0055,
    structure_count:       int,
    berths:                [128]History_Type_0037,
    berth_count:           int,
    routes:                [128]History_Type_0051,
    route_count:           int,
    terrain_edits:         [32]History_Type_0056,
    terrain_edit_count:    int,
    office:                History_Type_0058,
    settlement_connection: History_Type_0058,
    entrance:              History_Type_0058,
    diagnostics:           History_Type_0042,
}

// fixture-history-id: adriatic:packages/harbor.Harbor_Program
History_Type_0045 :: struct {
    role:                  History_Type_0052,
    purpose:               History_Type_0046,
    population:            int,
    target_capacity:       int,
...
History_Type_0055 :: struct {
    kind:     History_Type_0053,
    material: History_Type_0054,
    width:    f32,
    points:   [12]History_Type_0058,
    count:    int,
}
...
History_Type_0067 :: struct {
    ...
    style:                     History_Type_0063,
    boundary_form:             History_Type_0065,
    shoreline_form:            History_Type_0073,
    section_form_counts:       [9]int,
    cells:                     [567]History_Type_0066,
    segments:                  [96]History_Type_0071,
    segment_count:             int,
    slips:                     [40]History_Type_0074,
    slip_count:                int,
    props:                     [48]History_Type_0068,
    prop_count:                int,
    route:                     History_Type_0070,
    office:                    History_Type_0075,
    world_conditioned:         bool,
    world_origin:              History_Type_0075,
    world_yaw:                 f32,
    spacing_density:           f32,
...
History_Type_0068 :: struct {
    kind:     History_Type_0069,
    position: History_Type_0075,
    yaw:      f32,
}
...
History_Type_0078 :: struct {
    position: History_Type_0080,
    velocity: History_Type_0080,
    life:     f32,
    max_life: f32,
    size:     f32,
    seed:     u32,
...
History_Type_0079 :: struct {
    particles: [192]History_Type_0078,
    count:     int,
    spawn:     f32,
    seed:      u32,
}
...
History_Type_0084 :: struct {
    particles: [192]History_Type_0083,
    count:     int,
    spawn:     f32,
    seed:      u32,
}
...
History_Type_0089 :: struct {
    ...
    flight_model:             History_Type_0086,
    ...
    last_landing:             History_Type_0087,
    landing_feedback_seconds: f32,
    landing_intent_seconds:   f32,
    landing_intent:           bool,
    spawn_position:           History_Type_0034,
    spawn_orientation:        quaternion128,
    tuning:                   History_Type_0090,
}
...
History_Type_0094 :: struct {
    from:           int,
    to:             int,
    control_from:   History_Type_0098,
    control_to:     History_Type_0098,
    half_width:     f32,
    shoulder_width: f32,
    pavement:       History_Type_0097,
    use_intensity:  f32,
}

// fixture-history-id: adriatic:packages/roads.Graph
History_Type_0095 :: struct {
    nodes:      [64]History_Type_0096,
    node_count: int,
    edges:      [128]History_Type_0094,
    edge_count: int,
}

// fixture-history-id: adriatic:packages/roads.Node
History_Type_0096 :: struct {
    position:        History_Type_0098,
    up:              History_Type_0098,
    junction_radius: f32,
}
...
History_Type_0105 :: struct {
    active:      bool,
    kind:        History_Type_0106,
    from:        History_Type_0109,
    to:          History_Type_0109,
    origin:      History_Type_0107,
    destination: History_Type_0107,
    subject:     string,
    care:        History_Type_0104,
}
...
History_Type_0111 :: struct {
    quest:                        History_Type_0092,
    romance:                      History_Type_0110,
    repair:                       History_Type_0108,
    airfield_errand:              History_Type_0103,
    delivery:                     History_Type_0105,
    ...
    tarot_layout:                 History_Type_0113,
    clinic_visits:                int,
    last_clinic_visit_was_tumble: bool,
    resident_action_seen:         [History_Type_0109]u64,
}

// fixture-history-id: adriatic:packages/tarot.Card
History_Type_0112 :: distinct u8

// fixture-history-id: adriatic:packages/tarot.Layout
History_Type_0113 :: struct {
    spread:     History_Type_0116,
    placements: [10]History_Type_0115,
    count:      int,
    seed:       u32,
}
...
History_Type_0115 :: struct {
    card:        History_Type_0112,
    orientation: History_Type_0114,
    position:    string,
}
...
History_Type_0120 :: struct {
    levels:                [6]History_Type_0117,
    sea_level:             f32,
    revision:              u64,
    structures:            [dynamic]History_Type_0121,
    structure_count:       int,
    next_structure_id:     u64,
    road_graph:            History_Type_0095,
...
History_Type_0121 :: struct {
    ...
    rotation:      f32,
    color:         [4]u8,
    kind:          History_Type_0119,
    entrance_side: History_Type_0118,
    seed:          u32,
    building:      History_Type_0016,
}

// fixture-history-id: adriatic:packages/terrain.Tool
History_Type_0122 :: enum int {
    Raise     = 0,
    Smooth    = 1,
    Paint     = 2,
    Structure = 3,
...
History_Type_0124 :: struct {
    position: History_Type_0129,
    target:   History_Type_0129,
}
...
History_Type_0126 :: struct {
    poses:  [3]History_Type_0124,
    active: History_Type_0125,
}
...
History_Type_0128 :: struct {
    position:           History_Type_0129,
    velocity:           History_Type_0129,
    facing_yaw_radians: f32,
    grounded:           bool,
    turn_amount:        f32,
    brake_amount:       f32,
    ground_normal:      History_Type_0129,
    running:            bool,
    drifting:           bool,
    drift_charge:       f32,
    boost_seconds:      f32,
...
History_Type_0135 :: struct {
    velocity:       History_Type_0129,
    yaw_rate:       f32,
    reaction_force: History_Type_0129,
    body_roll:      f32,
    body_pitch:     f32,
    wheel_rotation: f32,
}
...
History_Type_0141 :: struct {
    editor_camera:      History_Type_0123,
    editor_focus:       History_Type_0129,
    player_camera:      History_Type_0123,
...
Fixture :: struct {
    project:                                History_Type_0120,
    authoring_tool:                         History_Type_0140,
    editor_ui:                              History_Type_0143,
    tool:                                   History_Type_0122,
    radius:                                 f32,
    strength:                               f32,
    hardness:                               f32,
    structure_selected:                     int,
    structure_kind:                         History_Type_0119,
    ...
    architecture_brush_shape:               History_Type_0167,
    architecture_brush_preset:              History_Type_0166,
    architecture_brush_strength:            f32,
    architecture_brush_hardness:            f32,
    marina_paint_mode:                      bool,
    marina_authored:                        bool,
    marina_authored_plan:                   History_Type_0067,
    harbor_authored_plan:                   History_Type_0044,
    harbor_authored_intervention:           History_Type_0043,
    marina_brush_radius:                    f32,
    farm_paint_mode:                        bool,
    farm_brush_radius:                      f32,
    farms:                                  [16]History_Type_0144,
    farm_count:                             int,
    farm_brush_yaw:                         f32,
    wreck_paint_mode:                       bool,
    wreck_brush_size:                       f32,
    wreck_brush_yaw:                        f32,
    wrecks:                                 [8]History_Type_0200,
    wreck_count:                            int,
    default_marinas:                        [2]History_Type_0067,
    default_harbors:                        [2]History_Type_0044,
    default_marina_islands:                 [2]History_Type_0107,
    ...
    road_pavement:                          History_Type_0097,
    in_map:                                 bool,
    player:                                 History_Type_0128,
    ...
    camera:                                 History_Type_0123,
    camera_pose:                            History_Type_0124,
    cameras:                                History_Type_0126,
    flight_camera:                          History_Type_0020,
    editor_camera:                          History_Type_0123,
    editor_focus:                           History_Type_0129,
    boat_traffic:                           History_Type_0012,
    marina_dinghy_borrowed:                 bool,
    occupant:                               History_Type_0137,
    pilot:                                  History_Type_0136,
    car:                                    History_Type_0139,
    car_drive:                              History_Type_0133,
    car_trailer:                            History_Type_0135,
    car_trailer_attached:                   bool,
    car_trailer_position:                   History_Type_0129,
    car_trailer_yaw:                        f32,
    postale:                                History_Type_0089,
    libellula:                              History_Type_0061,
    rondine:                                History_Type_0099,
    aircraft:                               History_Type_0130,
    ...
    settlement_plan:                        History_Type_0179,
    ...
    vehicle_paint_tool:                     History_Type_0196,
    ...
    attendant_position:                     History_Type_0129,
    gerta_position:                         History_Type_0129,
    story_state:                            History_Type_0111,
    player_mail:                            History_Type_0085,
    tracked_quest_node:                     History_Type_0091,
    quest_tracking_suppressed:              bool,
    quest_tracking_revision:                u64,
    atmosphere:                             History_Type_0005,
    vehicle_effects:                        History_Type_0081,
    wing_trails:                            History_Type_0084,
    petal_effects:                          History_Type_0079,
    tweak:                                  History_Type_0195,
    default_map_regeneration_seeds:         [2]u32,
    mouse_fur:                              History_Type_0152,
    mouse_pattern:                          History_Type_0153,
    mouse_headgear:                         History_Type_0151,
    mouse_scarf_enabled:                    bool,
    mouse_scarf_color:                      History_Type_0201,
...
History_Type_0156 :: struct {
    ...
    vehicle_seed: u32,
    wing_seed:    u32,
    cpu:          History_Type_0154,
    vehicle:      History_Type_0157,
    wing:         History_Type_0158,
    gpu:          History_Type_0155,
}
...
History_Type_0175 :: struct {
    route_length:               History_Type_0187,
    route_width:                History_Type_0187,
    route_grade:                History_Type_0187,
    route_length_by_class:      [8]History_Type_0187,
    route_width_by_class:       [8]History_Type_0187,
    intersection_spacing:       History_Type_0187,
    dead_end_frontage:          History_Type_0187,
    block_short_side:           History_Type_0187,
    block_long_side:            History_Type_0187,
    block_area:                 History_Type_0187,
    block_aspect:               History_Type_0187,
    block_irregularity:         History_Type_0187,
    parcel_frontage:            History_Type_0187,
    parcel_depth:               History_Type_0187,
    building_height:            History_Type_0187,
    building_footprint:         History_Type_0187,
    building_floors:            History_Type_0187,
    network_density:            f32,
    road_badness:               f32,
    attached_share:             f32,
...
History_Type_0179 :: struct {
    request:                      History_Type_0184,
    brush_pieces:                 [64]History_Type_0165,
    brush_piece_count:            int,
    next_brush_component_id:      u32,
    program:                      History_Type_0181,
    activity_points:              [512]History_Type_0163,
    activity_point_count:         int,
    inhabitants:                  [256]History_Type_0173,
    inhabitant_count:             int,
    village_reason:               History_Type_0198,
    neighborhoods:                [96]History_Type_0176,
    neighborhood_count:           int,
    macro_cells:                  [192]History_Type_0176,
    macro_cell_count:             int,
    routes:                       [320]History_Type_0180,
    ...
    growth_events:                [96]History_Type_0171,
    growth_event_count:           int,
    blocks:                       [128]History_Type_0164,
    block_count:                  int,
    sites:                        [256]History_Type_0189,
    site_piece_ids:               [256]u32,
    site_count:                   int,
    gardens:                      [64]History_Type_0169,
    garden_count:                 int,
    patios:                       [48]History_Type_0177,
    patio_count:                  int,
    rejected_sites:               [32]History_Type_0189,
    rejected_site_count:          int,
    decorative_foliage:           [32]History_Type_0121,
    decorative_foliage_count:     int,
    terrain_edits:                [192]History_Type_0191,
    terrain_edit_count:           int,
    ordinary_purposes:            [256]History_Type_0168,
    ordinary_purpose_count:       int,
    metrics:                      History_Type_0175,
    acceptance_failure:           History_Type_0161,
    valid:                        bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0180 :: struct {
    geometry:      History_Type_0185,
    class:         History_Type_0186,
    width:         f32,
    shoulder:      f32,
    pavement:      History_Type_0097,
    required:      bool,
...
History_Type_0181 :: struct {
    ordinary:             History_Type_0182,
    purposes:             [8]History_Type_0182,
    landmarks:            History_Type_0182,
    plazas:               History_Type_0182,
    parks:                History_Type_0182,
    vegetation:           History_Type_0182,
    residents:            History_Type_0182,
    workers:              History_Type_0182,
...
History_Type_0184 :: struct {
    region:  History_Type_0183,
    scale:   History_Type_0188,
    seed:    u32,
    center:  [2]f32,
    radius:  f32,
    density: f32,
...
History_Type_0189 :: struct {
    structure:           History_Type_0121,
    parcel:              History_Type_0003,
    kind:                History_Type_0190,
    tissue:              History_Type_0193,
    density:             f32,
    attached:            bool,
    accepted:            bool,
    landmark_kind:       History_Type_0174,
    purpose:             History_Type_0168,
    fountain_style:      History_Type_0035,
    fountain_radius:     f32,
...
History_Type_0195 :: struct {
    terrain:          History_Type_0194,
    atmosphere:       History_Type_0005,
    player:           History_Type_0127,
    player_animation: History_Type_0159,
    player_tail:      History_Type_0076,
    camera:           History_Type_0141,
    world:            History_Type_0199,
    particles:        History_Type_0156,
    car:              History_Type_0134,
    car_vehicle:      History_Type_0197,
    postale_airframe: History_Type_0028,
    postale_runtime:  History_Type_0031,
    postale_tuning:   History_Type_0090,
    postale_vehicle:  History_Type_0197,
    presentation:     History_Type_0160,
}

// fixture-history-id: adriatic:src.Vehicle_Paint_Tool
History_Type_0196 :: enum u8 {
    Brush    = 0,
    Bucket   = 1,
    Shape    = 2,
    Blend    = 3,
...
History_Type_0200 :: struct {
    cells:              [31]History_Type_0147,
    seed:               u32,
    form:               History_Type_0148,
    break_index:        int,
    second_break_index: int,
    part_count:         int,
    first_bay:          int,
    last_bay:           int,
    parts:              [3]History_Type_0149,
    quality:            History_Type_0150,
    origin_x:           f32,
    origin_z:           f32,
    yaw:                f32,
    scale:              f32,
...
History_Type_0201 :: History_Type_0202
