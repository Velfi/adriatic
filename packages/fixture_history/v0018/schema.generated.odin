...
// fixture-history-schema-version: 18
// fixture-history-manifest-sha256: 9a62a0356849d0731ceb6714cac7e618bd89276b94c3aa629b98b6f0f9a3e00a
package fixture_v0018
...
History_Type_0004 :: struct {
	structures: [dynamic]History_Type_0128,
	count: int,
...
History_Type_0024 :: struct {
	pose: History_Type_0131,
	base_pose: History_Type_0131,
	orbit_yaw: f32,
	orbit_pitch: f32,
	focal_length: f32,
	shake_phase: f32,
...
// fixture-history-id: adriatic:packages/roads.Alignment_Element_Kind
History_Type_0098 :: enum u8 {
	Legacy_Bezier = 0,
	Tangent = 1,
	Spiral = 2,
	Arc = 3,
...
History_Type_0099 :: struct {
	from: int,
	to: int,
	control_from: History_Type_0104,
	control_to: History_Type_0104,
	half_width: f32,
	shoulder_width: f32,
	pavement: History_Type_0102,
	use_intensity: f32,
	design_id: u32,
	alignment_kind: History_Type_0098,
	station_from: f32,
	station_to: f32,
	curvature_from: f32,
	curvature_to: f32,
	superelevation_from: f32,
	superelevation_to: f32,
	structure_kind: History_Type_0103,
	engineering_designed: bool,
	policy_pavement: History_Type_0102,
	authored_profile: bool,
}

// fixture-history-id: adriatic:packages/roads.Graph
History_Type_0100 :: struct {
	nodes: [64]History_Type_0101,
	node_count: int,
	edges: [128]History_Type_0099,
	edge_count: int,
}

// fixture-history-id: adriatic:packages/roads.Node
History_Type_0101 :: struct {
	position: History_Type_0104,
	up: History_Type_0104,
	junction_radius: f32,
}

// fixture-history-id: adriatic:packages/roads.Pavement
History_Type_0102 :: enum u8 {
	Asphalt = 0,
	Gravel = 1,
	Cobblestone = 2,
	Dirt = 3,
...
// fixture-history-id: adriatic:packages/roads.Structure_Span_Kind
...
History_Type_0111 :: struct {
	active: bool,
	kind: History_Type_0112,
	from: History_Type_0115,
	to: History_Type_0115,
	origin: History_Type_0113,
	destination: History_Type_0113,
	subject: string,
	care: History_Type_0110,
}
...
History_Type_0117 :: struct {
	...
	romance: History_Type_0116,
	repair: History_Type_0114,
	airfield_errand: History_Type_0109,
	delivery: History_Type_0111,
	...
	tarot_layout: History_Type_0119,
	clinic_visits: int,
	last_clinic_visit_was_tumble: bool,
	resident_action_seen: [History_Type_0115]u64,
}

// fixture-history-id: adriatic:packages/tarot.Card
History_Type_0118 :: distinct u8

// fixture-history-id: adriatic:packages/tarot.Layout
History_Type_0119 :: struct {
	spread: History_Type_0122,
	placements: [10]History_Type_0121,
	count: int,
	seed: u32,
}
...
History_Type_0121 :: struct {
	card: History_Type_0118,
	orientation: History_Type_0120,
	position: string,
}
...
History_Type_0127 :: struct {
	levels: [6]History_Type_0124,
	sea_level: f32,
	revision: u64,
	structures: [dynamic]History_Type_0128,
	structure_count: int,
	next_structure_id: u64,
	road_graph: History_Type_0100,
...
History_Type_0128 :: struct {
	...
	rotation: f32,
	color: [4]u8,
	kind: History_Type_0126,
	entrance_side: History_Type_0125,
	seed: u32,
	building: History_Type_0020,
}

// fixture-history-id: adriatic:packages/terrain.Tool
History_Type_0129 :: enum int {
	Raise = 0,
	Smooth = 1,
	Paint = 2,
	Structure = 3,
...
History_Type_0131 :: struct {
	position: History_Type_0136,
	target: History_Type_0136,
}
...
History_Type_0133 :: struct {
	poses: [3]History_Type_0131,
	active: History_Type_0132,
}
...
History_Type_0135 :: struct {
	position: History_Type_0136,
	velocity: History_Type_0136,
	facing_yaw_radians: f32,
	grounded: bool,
	turn_amount: f32,
	brake_amount: f32,
	ground_normal: History_Type_0136,
	running: bool,
	drifting: bool,
	drift_charge: f32,
	boost_seconds: f32,
...
History_Type_0142 :: struct {
	velocity: History_Type_0136,
	yaw_rate: f32,
	reaction_force: History_Type_0136,
	body_roll: f32,
	body_pitch: f32,
	wheel_rotation: f32,
}
...
History_Type_0148 :: struct {
	editor_camera: History_Type_0130,
	editor_focus: History_Type_0136,
	player_camera: History_Type_0130,
...
Fixture :: struct {
	project: History_Type_0127,
	authoring_tool: History_Type_0147,
	editor_ui: History_Type_0150,
	tool: History_Type_0129,
	radius: f32,
	strength: f32,
	hardness: f32,
	structure_selected: int,
	structure_kind: History_Type_0126,
	...
	architecture_brush_shape: History_Type_0176,
	architecture_brush_preset: History_Type_0175,
	...
	camera: History_Type_0130,
	camera_pose: History_Type_0131,
	cameras: History_Type_0133,
	flight_camera: History_Type_0024,
	editor_camera: History_Type_0130,
	editor_focus: History_Type_0136,
	boat_traffic: History_Type_0016,
	marina_dinghy_borrowed: bool,
	occupant: History_Type_0144,
	pilot: History_Type_0143,
	car: History_Type_0146,
	car_drive: History_Type_0140,
	car_trailer: History_Type_0142,
	car_trailer_attached: bool,
	car_trailer_position: History_Type_0136,
	car_trailer_yaw: f32,
	postale: History_Type_0093,
	libellula: History_Type_0065,
	rondine: History_Type_0105,
	aircraft: History_Type_0137,
	...
	settlement_plan: History_Type_0188,
	...
	vehicle_paint_tool: History_Type_0205,
	...
	attendant_position: History_Type_0136,
	gerta_position: History_Type_0136,
	story_state: History_Type_0117,
	...
	tweak: History_Type_0204,
	default_map_regeneration_seeds: [2]u32,
	mouse_fur: History_Type_0161,
	mouse_pattern: History_Type_0162,
	mouse_headgear: History_Type_0160,
	mouse_scarf_enabled: bool,
	mouse_scarf_color: History_Type_0210,
	mouse_scarf_rotation: f32,
	mouse_scarf_angular_velocity: f32,
	notes: [64]History_Type_0153,
	note_count: int,
}
...
History_Type_0153 :: struct {
	text: [256]u8,
	target: History_Type_0154,
	target_id: u64,
	fallback_position: History_Type_0136,
}
...
History_Type_0165 :: struct {
	...
	vehicle_seed: u32,
	wing_seed: u32,
	cpu: History_Type_0163,
	vehicle: History_Type_0166,
	wing: History_Type_0167,
	gpu: History_Type_0164,
}
...
History_Type_0184 :: struct {
	route_length: History_Type_0196,
	route_width: History_Type_0196,
	route_grade: History_Type_0196,
	route_length_by_class: [8]History_Type_0196,
	route_width_by_class: [8]History_Type_0196,
	intersection_spacing: History_Type_0196,
	dead_end_frontage: History_Type_0196,
	block_short_side: History_Type_0196,
	block_long_side: History_Type_0196,
	block_area: History_Type_0196,
	block_aspect: History_Type_0196,
	block_irregularity: History_Type_0196,
	parcel_frontage: History_Type_0196,
	parcel_depth: History_Type_0196,
	building_height: History_Type_0196,
	building_base_elevation: History_Type_0196,
	building_footprint: History_Type_0196,
	building_floors: History_Type_0196,
	network_density: f32,
	road_badness: f32,
	attached_share: f32,
...
History_Type_0188 :: struct {
	request: History_Type_0193,
	brush_pieces: [64]History_Type_0174,
	brush_piece_count: int,
	next_brush_component_id: u32,
	program: History_Type_0190,
	activity_points: [512]History_Type_0172,
	activity_point_count: int,
	inhabitants: [256]History_Type_0182,
	inhabitant_count: int,
	village_reason: History_Type_0207,
	neighborhoods: [96]History_Type_0185,
	neighborhood_count: int,
	macro_cells: [192]History_Type_0185,
	macro_cell_count: int,
	routes: [320]History_Type_0189,
	...
	growth_events: [96]History_Type_0180,
	growth_event_count: int,
	blocks: [128]History_Type_0173,
	block_count: int,
	sites: [256]History_Type_0198,
	site_piece_ids: [256]u32,
	site_count: int,
	gardens: [64]History_Type_0178,
	garden_count: int,
	patios: [48]History_Type_0186,
	patio_count: int,
	rejected_sites: [32]History_Type_0198,
	rejected_site_count: int,
	decorative_foliage: [32]History_Type_0128,
	decorative_foliage_count: int,
	terrain_edits: [192]History_Type_0200,
	terrain_edit_count: int,
	ordinary_purposes: [256]History_Type_0177,
	ordinary_purpose_count: int,
	metrics: History_Type_0184,
	acceptance_failure: History_Type_0170,
	valid: bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0189 :: struct {
	geometry: History_Type_0194,
	class: History_Type_0195,
	width: f32,
	shoulder: f32,
	pavement: History_Type_0102,
	required: bool,
...
History_Type_0190 :: struct {
	ordinary: History_Type_0191,
	purposes: [8]History_Type_0191,
	landmarks: History_Type_0191,
	plazas: History_Type_0191,
	parks: History_Type_0191,
	vegetation: History_Type_0191,
	residents: History_Type_0191,
	workers: History_Type_0191,
...
History_Type_0193 :: struct {
	region: History_Type_0192,
	scale: History_Type_0197,
	seed: u32,
	center: [2]f32,
	radius: f32,
	density: f32,
...
History_Type_0198 :: struct {
	...
	attached: bool,
	accepted: bool,
	landmark_kind: History_Type_0183,
	purpose: History_Type_0177,
...
History_Type_0204 :: struct {
	terrain: History_Type_0203,
	atmosphere: History_Type_0005,
	player: History_Type_0134,
	player_animation: History_Type_0168,
	player_tail: History_Type_0080,
	camera: History_Type_0148,
	world: History_Type_0208,
	particles: History_Type_0165,
	car: History_Type_0141,
	car_vehicle: History_Type_0206,
	postale_airframe: History_Type_0032,
	postale_runtime: History_Type_0035,
	postale_tuning: History_Type_0094,
	postale_vehicle: History_Type_0206,
	presentation: History_Type_0169,
}
...
History_Type_0209 :: struct {
	cells: [31]History_Type_0156,
	seed: u32,
	form: History_Type_0157,
	break_index: int,
	second_break_index: int,
	part_count: int,
	first_bay: int,
	last_bay: int,
	parts: [3]History_Type_0158,
	quality: History_Type_0159,
	origin_x: f32,
	origin_z: f32,
	yaw: f32,
	scale: f32,
...
History_Type_0210 :: History_Type_0211

// fixture-history-id: zelda_engine:render2d.Color
History_Type_0211 :: struct {
	r: u8,
	g: u8,
	b: u8,
	a: u8,
