...
// fixture-history-schema-version: 4
// fixture-history-manifest-sha256: fad52f4e0a38b35fffdf29ae3ffb3f91251780fe0ce2dc5990beba76f1e518fa
package fixture_v0004
...
History_Type_0004 :: struct {
    structures:   [dynamic]History_Type_0091,
    count:        int,
...
History_Type_0020 :: struct {
    pose:                     History_Type_0094,
    base_pose:                History_Type_0094,
    orbit_yaw:                f32,
    orbit_pitch:              f32,
    focal_length:             f32,
    shake_phase:              f32,
    shake_intensity:          f32,
    previous_target_position: History_Type_0033,
    initialized:              bool,
}
...
History_Type_0026 :: struct {
    forward: History_Type_0033,
    up:      History_Type_0033,
    right:   History_Type_0033,
}

// fixture-history-id: adriatic:packages/flight.Body_State
History_Type_0027 :: struct {
    position:         History_Type_0033,
    velocity:         History_Type_0033,
    angular_velocity: History_Type_0033,
    basis:            History_Type_0026,
}
...
History_Type_0032 :: struct {
    rotor_thrusts:        History_Type_0033,
    rotor_rpm_normalized: History_Type_0033,
    total_thrust:         f32,
}

// fixture-history-id: adriatic:packages/flight.Vec3
History_Type_0033 :: [3]f32

// fixture-history-id: adriatic:packages/libellula.Runtime
History_Type_0034 :: struct {
    body:           History_Type_0027,
    vehicle:        History_Type_0109,
    airframe:       History_Type_0030,
    flight_runtime: History_Type_0031,
    telemetry:      History_Type_0032,
    tuning:         History_Type_0035,
    spawn_position: History_Type_0033,
    spawn_basis:    History_Type_0026,
    throttle:       f32,
    pitch:          f32,
    roll:           f32,
    yaw:            f32,
    rotor_turns:    History_Type_0033,
    grounded:       bool,
    was_grounded:   bool,
    crashed:        bool,
    lift_active:    bool,
...
History_Type_0040 :: struct {
    ...
    style:                     History_Type_0036,
    boundary_form:             History_Type_0038,
    shoreline_form:            History_Type_0046,
    section_form_counts:       [9]int,
    cells:                     [567]History_Type_0039,
    segments:                  [96]History_Type_0044,
    segment_count:             int,
    slips:                     [40]History_Type_0047,
    slip_count:                int,
    props:                     [48]History_Type_0041,
    prop_count:                int,
    route:                     History_Type_0043,
    office:                    History_Type_0048,
    world_conditioned:         bool,
    world_origin:              History_Type_0048,
    world_yaw:                 f32,
    spacing_density:           f32,
...
History_Type_0051 :: struct {
    position: History_Type_0053,
    velocity: History_Type_0053,
    life:     f32,
    max_life: f32,
    size:     f32,
    seed:     u32,
...
History_Type_0052 :: struct {
    particles: [192]History_Type_0051,
    count:     int,
    spawn:     f32,
    seed:      u32,
}
...
History_Type_0057 :: struct {
    particles: [192]History_Type_0056,
    count:     int,
    spawn:     f32,
    seed:      u32,
}
...
History_Type_0060 :: struct {
    body:                     History_Type_0027,
    vehicle:                  History_Type_0109,
    airframe:                 History_Type_0025,
    flight_runtime:           History_Type_0028,
    telemetry:                History_Type_0029,
    throttle:                 f32,
    flap_fraction:            f32,
    propeller_turns:          f32,
    pitch:                    f32,
    ...
    last_landing:             History_Type_0058,
    landing_feedback_seconds: f32,
    landing_intent_seconds:   f32,
    landing_intent:           bool,
    spawn_position:           History_Type_0033,
    spawn_basis:              History_Type_0026,
    tuning:                   History_Type_0061,
}
...
History_Type_0065 :: struct {
    from:           int,
    to:             int,
    control_from:   History_Type_0069,
    control_to:     History_Type_0069,
    half_width:     f32,
    shoulder_width: f32,
    pavement:       History_Type_0068,
}

// fixture-history-id: adriatic:packages/roads.Graph
History_Type_0066 :: struct {
    nodes:      [64]History_Type_0067,
    node_count: int,
    edges:      [128]History_Type_0065,
    edge_count: int,
}

// fixture-history-id: adriatic:packages/roads.Node
History_Type_0067 :: struct {
    position:        History_Type_0069,
    up:              History_Type_0069,
    junction_radius: f32,
}
...
History_Type_0075 :: struct {
    ...
    from:        History_Type_0079,
    to:          History_Type_0079,
    origin:      History_Type_0077,
    destination: History_Type_0077,
    subject:     string,
}
...
History_Type_0081 :: struct {
    quest:                History_Type_0063,
    romance:              History_Type_0080,
    repair:               History_Type_0078,
    airfield_errand:      History_Type_0074,
    delivery:             History_Type_0075,
    ...
    tarot_layout:         History_Type_0083,
    clinic_visits:        int,
    resident_action_seen: [History_Type_0079]u64,
}

// fixture-history-id: adriatic:packages/tarot.Card
History_Type_0082 :: distinct u8

// fixture-history-id: adriatic:packages/tarot.Layout
History_Type_0083 :: struct {
    spread:     History_Type_0086,
    placements: [10]History_Type_0085,
    count:      int,
    seed:       u32,
}

// fixture-history-id: adriatic:packages/tarot.Orientation
History_Type_0084 :: enum int {
    Upright  = 0,
    Reversed = 1,
}
...
History_Type_0085 :: struct {
    card:        History_Type_0082,
    orientation: History_Type_0084,
    position:    string,
}
...
History_Type_0090 :: struct {
    levels:                [6]History_Type_0087,
    sea_level:             f32,
    revision:              u64,
    structures:            [dynamic]History_Type_0091,
    structure_count:       int,
    next_structure_id:     u64,
    road_graph:            History_Type_0066,
...
History_Type_0091 :: struct {
    ...
    rotation:      f32,
    color:         [4]u8,
    kind:          History_Type_0089,
    entrance_side: History_Type_0088,
    seed:          u32,
...
History_Type_0094 :: struct {
    position: History_Type_0099,
    target:   History_Type_0099,
}
...
History_Type_0096 :: struct {
    poses:  [3]History_Type_0094,
    active: History_Type_0095,
}
...
History_Type_0098 :: struct {
    position:           History_Type_0099,
    velocity:           History_Type_0099,
    facing_yaw_radians: f32,
    grounded:           bool,
    turn_amount:        f32,
    brake_amount:       f32,
    ground_normal:      History_Type_0099,
    running:            bool,
    drifting:           bool,
    drift_charge:       f32,
    boost_seconds:      f32,
...
History_Type_0105 :: struct {
    velocity:       History_Type_0099,
    yaw_rate:       f32,
    reaction_force: History_Type_0099,
    body_roll:      f32,
    body_pitch:     f32,
    wheel_rotation: f32,
}
...
History_Type_0111 :: struct {
    editor_camera:      History_Type_0093,
    editor_focus:       History_Type_0099,
    player_camera:      History_Type_0093,
...
Fixture :: struct {
    project:                                History_Type_0090,
    authoring_tool:                         History_Type_0110,
    editor_ui:                              History_Type_0113,
    tool:                                   History_Type_0092,
    radius:                                 f32,
    strength:                               f32,
    hardness:                               f32,
    structure_selected:                     int,
    structure_kind:                         History_Type_0089,
    ...
    road_pavement:                          History_Type_0068,
    in_map:                                 bool,
    player:                                 History_Type_0098,
    ...
    camera:                                 History_Type_0093,
    camera_pose:                            History_Type_0094,
    cameras:                                History_Type_0096,
    flight_camera:                          History_Type_0020,
    editor_camera:                          History_Type_0093,
    editor_focus:                           History_Type_0099,
    boat_traffic:                           History_Type_0012,
    marina_dinghy_borrowed:                 bool,
    occupant:                               History_Type_0107,
    pilot:                                  History_Type_0106,
    car:                                    History_Type_0109,
    car_drive:                              History_Type_0103,
    car_trailer:                            History_Type_0105,
    car_trailer_attached:                   bool,
    car_trailer_position:                   History_Type_0099,
    car_trailer_yaw:                        f32,
    postale:                                History_Type_0060,
    libellula:                              History_Type_0034,
    rondine:                                History_Type_0070,
    aircraft:                               History_Type_0100,
    ...
    settlement_plan:                        History_Type_0143,
    ...
    vehicle_paint_tool:                     History_Type_0160,
    vehicle_paint_component:                int,
    vehicle_paint_component_mask:           [5]bool,
    vehicle_paint_saved_postale_position:   History_Type_0033,
    vehicle_paint_saved_libellula_position: History_Type_0033,
    ...
    attendant_position:                     History_Type_0099,
    gerta_position:                         History_Type_0099,
    story_state:                            History_Type_0081,
    tracked_quest_node:                     History_Type_0062,
    quest_tracking_suppressed:              bool,
    quest_tracking_revision:                u64,
    camera_target_lock:                     bool,
    atmosphere:                             History_Type_0005,
    vehicle_effects:                        History_Type_0054,
    wing_trails:                            History_Type_0057,
    petal_effects:                          History_Type_0052,
    tweak:                                  History_Type_0159,
    mouse_fur:                              History_Type_0122,
    mouse_pattern:                          History_Type_0123,
    mouse_headgear:                         History_Type_0121,
    mouse_scarf_enabled:                    bool,
    mouse_scarf_color:                      History_Type_0165,
...
History_Type_0126 :: struct {
    ...
    vehicle_seed: u32,
    wing_seed:    u32,
    cpu:          History_Type_0124,
    vehicle:      History_Type_0127,
    wing:         History_Type_0128,
    gpu:          History_Type_0125,
}
...
History_Type_0131 :: enum int {
    ...
    Submerged_Site          = 8,
    Missing_Buildings       = 9,
    Insufficient_Buildings  = 10,
    Missing_Village_Program = 11,
    Missing_Blocks          = 12,
    Fabric_Form             = 13,
    Height_Band             = 14,
    Height_Outlier          = 15,
...
History_Type_0141 :: struct {
    route_length:          History_Type_0151,
    route_width:           History_Type_0151,
    route_grade:           History_Type_0151,
    route_length_by_class: [8]History_Type_0151,
    route_width_by_class:  [8]History_Type_0151,
    intersection_spacing:  History_Type_0151,
    dead_end_frontage:     History_Type_0151,
    block_short_side:      History_Type_0151,
    block_long_side:       History_Type_0151,
    block_area:            History_Type_0151,
    block_aspect:          History_Type_0151,
    block_irregularity:    History_Type_0151,
    parcel_frontage:       History_Type_0151,
    parcel_depth:          History_Type_0151,
    building_height:       History_Type_0151,
    building_footprint:    History_Type_0151,
    building_floors:       History_Type_0151,
    network_density:       f32,
    road_badness:          f32,
    attached_share:        f32,
...
History_Type_0143 :: struct {
    request:                      History_Type_0148,
    brush_pieces:                 [64]History_Type_0135,
    brush_piece_count:            int,
    next_brush_component_id:      u32,
    program:                      History_Type_0145,
    activity_points:              [512]History_Type_0133,
    activity_point_count:         int,
    inhabitants:                  [256]History_Type_0139,
    inhabitant_count:             int,
    village_reason:               History_Type_0162,
    neighborhoods:                [96]History_Type_0142,
    neighborhood_count:           int,
    macro_cells:                  [192]History_Type_0142,
    macro_cell_count:             int,
    routes:                       [320]History_Type_0144,
    ...
    blocks:                       [128]History_Type_0134,
    block_count:                  int,
    sites:                        [256]History_Type_0153,
    site_piece_ids:               [256]u32,
    site_count:                   int,
    rejected_sites:               [32]History_Type_0153,
    rejected_site_count:          int,
    decorative_foliage:           [32]History_Type_0091,
    decorative_foliage_count:     int,
    terrain_edits:                [192]History_Type_0155,
    terrain_edit_count:           int,
    ordinary_purposes:            [256]History_Type_0138,
    ordinary_purpose_count:       int,
    metrics:                      History_Type_0141,
    acceptance_failure:           History_Type_0131,
    valid:                        bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0144 :: struct {
    geometry:      History_Type_0149,
    class:         History_Type_0150,
    width:         f32,
    shoulder:      f32,
    pavement:      History_Type_0068,
    required:      bool,
...
History_Type_0145 :: struct {
    ordinary:             History_Type_0146,
    purposes:             [8]History_Type_0146,
    landmarks:            History_Type_0146,
    plazas:               History_Type_0146,
    parks:                History_Type_0146,
    vegetation:           History_Type_0146,
    residents:            History_Type_0146,
    workers:              History_Type_0146,
...
History_Type_0148 :: struct {
    region:  History_Type_0147,
    scale:   History_Type_0152,
    seed:    u32,
    center:  [2]f32,
    radius:  f32,
    density: f32,
...
History_Type_0153 :: struct {
    structure:     History_Type_0091,
    parcel:        History_Type_0003,
    kind:          History_Type_0154,
    tissue:        History_Type_0157,
    density:       f32,
    attached:      bool,
    accepted:      bool,
    landmark_kind: History_Type_0140,
    purpose:       History_Type_0138,
}
...
History_Type_0159 :: struct {
    terrain:          History_Type_0158,
    atmosphere:       History_Type_0005,
    player:           History_Type_0097,
    player_animation: History_Type_0129,
    player_tail:      History_Type_0049,
    camera:           History_Type_0111,
    world:            History_Type_0163,
    particles:        History_Type_0126,
    car:              History_Type_0104,
    car_vehicle:      History_Type_0161,
    postale_airframe: History_Type_0025,
    postale_runtime:  History_Type_0028,
    postale_tuning:   History_Type_0061,
    postale_vehicle:  History_Type_0161,
    presentation:     History_Type_0130,
}

// fixture-history-id: adriatic:src.Vehicle_Paint_Tool
History_Type_0160 :: enum u8 {
    Brush    = 0,
    Bucket   = 1,
    Shape    = 2,
    Blend    = 3,
...
History_Type_0164 :: struct {
    cells:              [31]History_Type_0117,
    seed:               u32,
    form:               History_Type_0118,
    break_index:        int,
    second_break_index: int,
    part_count:         int,
    first_bay:          int,
    last_bay:           int,
    parts:              [3]History_Type_0119,
    quality:            History_Type_0120,
    origin_x:           f32,
    origin_z:           f32,
    yaw:                f32,
    scale:              f32,
...
History_Type_0165 :: History_Type_0166
