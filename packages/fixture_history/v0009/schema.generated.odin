...
// fixture-history-schema-version: 9
// fixture-history-manifest-sha256: 0a2d40f60c1f2bfe6693aea3aa9ca316001c7181e04b176350326e625a0418a6
package fixture_v0009
...
History_Type_0004 :: struct {
    structures:   [dynamic]History_Type_0120,
    count:        int,
...
History_Type_0020 :: struct {
    pose:                     History_Type_0123,
    base_pose:                History_Type_0123,
    orbit_yaw:                f32,
    orbit_pitch:              f32,
    focal_length:             f32,
    shake_phase:              f32,
...
History_Type_0088 :: struct {
    ...
    flight_model:             History_Type_0085,
    ...
    last_landing:             History_Type_0086,
    landing_feedback_seconds: f32,
    landing_intent_seconds:   f32,
    landing_intent:           bool,
    spawn_position:           History_Type_0034,
    spawn_orientation:        quaternion128,
    tuning:                   History_Type_0089,
}
...
History_Type_0093 :: struct {
    from:           int,
    to:             int,
    control_from:   History_Type_0097,
    control_to:     History_Type_0097,
    half_width:     f32,
    shoulder_width: f32,
    pavement:       History_Type_0096,
    use_intensity:  f32,
}

// fixture-history-id: adriatic:packages/roads.Graph
History_Type_0094 :: struct {
    nodes:      [64]History_Type_0095,
    node_count: int,
    edges:      [128]History_Type_0093,
    edge_count: int,
}

// fixture-history-id: adriatic:packages/roads.Node
History_Type_0095 :: struct {
    position:        History_Type_0097,
    up:              History_Type_0097,
    junction_radius: f32,
}
...
History_Type_0104 :: struct {
    active:      bool,
    kind:        History_Type_0105,
    from:        History_Type_0108,
    to:          History_Type_0108,
    origin:      History_Type_0106,
    destination: History_Type_0106,
    subject:     string,
    care:        History_Type_0103,
}
...
History_Type_0110 :: struct {
    quest:                        History_Type_0091,
    romance:                      History_Type_0109,
    repair:                       History_Type_0107,
    airfield_errand:              History_Type_0102,
    delivery:                     History_Type_0104,
    ...
    tarot_layout:                 History_Type_0112,
    clinic_visits:                int,
    last_clinic_visit_was_tumble: bool,
    resident_action_seen:         [History_Type_0108]u64,
}

// fixture-history-id: adriatic:packages/tarot.Card
History_Type_0111 :: distinct u8

// fixture-history-id: adriatic:packages/tarot.Layout
History_Type_0112 :: struct {
    spread:     History_Type_0115,
    placements: [10]History_Type_0114,
    count:      int,
    seed:       u32,
}
...
History_Type_0114 :: struct {
    card:        History_Type_0111,
    orientation: History_Type_0113,
    position:    string,
}
...
History_Type_0119 :: struct {
    levels:                [6]History_Type_0116,
    sea_level:             f32,
    revision:              u64,
    structures:            [dynamic]History_Type_0120,
    structure_count:       int,
    next_structure_id:     u64,
    road_graph:            History_Type_0094,
...
History_Type_0120 :: struct {
    ...
    rotation:      f32,
    color:         [4]u8,
    kind:          History_Type_0118,
    entrance_side: History_Type_0117,
    seed:          u32,
...
History_Type_0123 :: struct {
    position: History_Type_0128,
    target:   History_Type_0128,
}
...
History_Type_0125 :: struct {
    poses:  [3]History_Type_0123,
    active: History_Type_0124,
}
...
History_Type_0127 :: struct {
    position:           History_Type_0128,
    velocity:           History_Type_0128,
    facing_yaw_radians: f32,
    grounded:           bool,
    turn_amount:        f32,
    brake_amount:       f32,
    ground_normal:      History_Type_0128,
    running:            bool,
    drifting:           bool,
    drift_charge:       f32,
    boost_seconds:      f32,
...
History_Type_0134 :: struct {
    velocity:       History_Type_0128,
    yaw_rate:       f32,
    reaction_force: History_Type_0128,
    body_roll:      f32,
    body_pitch:     f32,
    wheel_rotation: f32,
}
...
History_Type_0140 :: struct {
    editor_camera:      History_Type_0122,
    editor_focus:       History_Type_0128,
    player_camera:      History_Type_0122,
...
Fixture :: struct {
    project:                                History_Type_0119,
    authoring_tool:                         History_Type_0139,
    editor_ui:                              History_Type_0142,
    tool:                                   History_Type_0121,
    radius:                                 f32,
    strength:                               f32,
    hardness:                               f32,
    structure_selected:                     int,
    structure_kind:                         History_Type_0118,
    ...
    architecture_brush_shape:               History_Type_0166,
    architecture_brush_preset:              History_Type_0165,
    ...
    road_pavement:                          History_Type_0096,
    in_map:                                 bool,
    ...
    camera:                                 History_Type_0122,
    camera_pose:                            History_Type_0123,
    cameras:                                History_Type_0125,
    flight_camera:                          History_Type_0020,
    editor_camera:                          History_Type_0122,
    editor_focus:                           History_Type_0128,
    boat_traffic:                           History_Type_0012,
    marina_dinghy_borrowed:                 bool,
    occupant:                               History_Type_0136,
    pilot:                                  History_Type_0135,
    car:                                    History_Type_0138,
    car_drive:                              History_Type_0132,
    car_trailer:                            History_Type_0134,
    car_trailer_attached:                   bool,
    car_trailer_position:                   History_Type_0128,
    car_trailer_yaw:                        f32,
    postale:                                History_Type_0088,
    libellula:                              History_Type_0061,
    rondine:                                History_Type_0098,
    aircraft:                               History_Type_0129,
    ...
    settlement_plan:                        History_Type_0178,
    ...
    vehicle_paint_tool:                     History_Type_0195,
    ...
    attendant_position:                     History_Type_0128,
    gerta_position:                         History_Type_0128,
    story_state:                            History_Type_0110,
    tracked_quest_node:                     History_Type_0090,
    ...
    tweak:                                  History_Type_0194,
    default_map_regeneration_seeds:         [2]u32,
    mouse_fur:                              History_Type_0151,
    mouse_pattern:                          History_Type_0152,
    mouse_headgear:                         History_Type_0150,
    mouse_scarf_enabled:                    bool,
    mouse_scarf_color:                      History_Type_0200,
...
History_Type_0155 :: struct {
    ...
    vehicle_seed: u32,
    wing_seed:    u32,
    cpu:          History_Type_0153,
    vehicle:      History_Type_0156,
    wing:         History_Type_0157,
    gpu:          History_Type_0154,
}
...
History_Type_0174 :: struct {
    route_length:               History_Type_0186,
    route_width:                History_Type_0186,
    route_grade:                History_Type_0186,
    route_length_by_class:      [8]History_Type_0186,
    route_width_by_class:       [8]History_Type_0186,
    intersection_spacing:       History_Type_0186,
    dead_end_frontage:          History_Type_0186,
    block_short_side:           History_Type_0186,
    block_long_side:            History_Type_0186,
    block_area:                 History_Type_0186,
    block_aspect:               History_Type_0186,
    block_irregularity:         History_Type_0186,
    parcel_frontage:            History_Type_0186,
    parcel_depth:               History_Type_0186,
    building_height:            History_Type_0186,
    building_footprint:         History_Type_0186,
    building_floors:            History_Type_0186,
    network_density:            f32,
    road_badness:               f32,
    attached_share:             f32,
...
History_Type_0178 :: struct {
    request:                      History_Type_0183,
    brush_pieces:                 [64]History_Type_0164,
    brush_piece_count:            int,
    next_brush_component_id:      u32,
    program:                      History_Type_0180,
    activity_points:              [512]History_Type_0162,
    activity_point_count:         int,
    inhabitants:                  [256]History_Type_0172,
    inhabitant_count:             int,
    village_reason:               History_Type_0197,
    neighborhoods:                [96]History_Type_0175,
    neighborhood_count:           int,
    macro_cells:                  [192]History_Type_0175,
    macro_cell_count:             int,
    routes:                       [320]History_Type_0179,
    ...
    growth_events:                [96]History_Type_0170,
    growth_event_count:           int,
    blocks:                       [128]History_Type_0163,
    block_count:                  int,
    sites:                        [256]History_Type_0188,
    site_piece_ids:               [256]u32,
    site_count:                   int,
    gardens:                      [64]History_Type_0168,
    garden_count:                 int,
    patios:                       [48]History_Type_0176,
    patio_count:                  int,
    rejected_sites:               [32]History_Type_0188,
    rejected_site_count:          int,
    decorative_foliage:           [32]History_Type_0120,
    decorative_foliage_count:     int,
    terrain_edits:                [192]History_Type_0190,
    terrain_edit_count:           int,
    ordinary_purposes:            [256]History_Type_0167,
    ordinary_purpose_count:       int,
    metrics:                      History_Type_0174,
    acceptance_failure:           History_Type_0160,
    valid:                        bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0179 :: struct {
    geometry:      History_Type_0184,
    class:         History_Type_0185,
    width:         f32,
    shoulder:      f32,
    pavement:      History_Type_0096,
    required:      bool,
...
History_Type_0180 :: struct {
    ordinary:             History_Type_0181,
    purposes:             [8]History_Type_0181,
    landmarks:            History_Type_0181,
    plazas:               History_Type_0181,
    parks:                History_Type_0181,
    vegetation:           History_Type_0181,
    residents:            History_Type_0181,
    workers:              History_Type_0181,
...
History_Type_0183 :: struct {
    region:  History_Type_0182,
    scale:   History_Type_0187,
    seed:    u32,
    center:  [2]f32,
    radius:  f32,
    density: f32,
...
History_Type_0188 :: struct {
    structure:           History_Type_0120,
    parcel:              History_Type_0003,
    kind:                History_Type_0189,
    tissue:              History_Type_0192,
    density:             f32,
    attached:            bool,
    accepted:            bool,
    landmark_kind:       History_Type_0173,
    purpose:             History_Type_0167,
...
History_Type_0190 :: struct {
    kind:          History_Type_0191,
    center:        [2]f32,
    half_extent:   [2]f32,
    target_height: f32,
    feather:       f32,
...
History_Type_0194 :: struct {
    terrain:          History_Type_0193,
    atmosphere:       History_Type_0005,
    player:           History_Type_0126,
    player_animation: History_Type_0158,
    player_tail:      History_Type_0076,
    camera:           History_Type_0140,
    world:            History_Type_0198,
    particles:        History_Type_0155,
    car:              History_Type_0133,
    car_vehicle:      History_Type_0196,
    postale_airframe: History_Type_0028,
    postale_runtime:  History_Type_0031,
    postale_tuning:   History_Type_0089,
    postale_vehicle:  History_Type_0196,
    presentation:     History_Type_0159,
}
...
History_Type_0199 :: struct {
    cells:              [31]History_Type_0146,
    seed:               u32,
    form:               History_Type_0147,
    break_index:        int,
    second_break_index: int,
    part_count:         int,
    first_bay:          int,
    last_bay:           int,
    parts:              [3]History_Type_0148,
    quality:            History_Type_0149,
    origin_x:           f32,
    origin_z:           f32,
    yaw:                f32,
    scale:              f32,
...
History_Type_0200 :: History_Type_0201
