...
// fixture-history-schema-version: 11
// fixture-history-manifest-sha256: d89044b87f4112b782b0dae59f302236b94d6bcc6c5747b19a3fcda635554ebd
package fixture_v0011
...
History_Type_0004 :: struct {
	structures: [dynamic]History_Type_0123,
	count: int,
...
History_Type_0005 :: struct {
	...
	lunar_days: f32,
	front_seconds: f32,
	weather: History_Type_0009,
	override: History_Type_0008,
	paused: bool,
	schedule: History_Type_0006,
}
...
History_Type_0010 :: struct {
	class: History_Type_0012,
	position: History_Type_0015,
	velocity: History_Type_0015,
	yaw: f32,
	speed: f32,
	throttle: f32,
	behavior: History_Type_0011,
	route: [8]History_Type_0015,
	route_count: int,
	route_index: int,
	schedule: [5]History_Type_0013,
	schedule_count: int,
	loiter_center: History_Type_0015,
	loiter_radius: f32,
	loiter_phase: f32,
	mooring_position: History_Type_0015,
	mooring_yaw: f32,
	wake: [48]History_Type_0016,
	wake_count: int,
	wake_distance: f32,
}

// fixture-history-id: adriatic:packages/boats.Behavior
History_Type_0011 :: enum u8 {
	Transit = 0,
	Patrol = 1,
	Loiter = 2,
	Moored = 3,
...
History_Type_0018 :: struct {
	archetype: History_Type_0017,
	purpose: History_Type_0020,
	region: History_Type_0021,
	landmark_kind: History_Type_0019,
}
...
History_Type_0022 :: struct {
	pose: History_Type_0126,
	base_pose: History_Type_0126,
	orbit_yaw: f32,
	orbit_pitch: f32,
	focal_length: f32,
	shake_phase: f32,
	shake_intensity: f32,
	previous_target_position: History_Type_0036,
	initialized: bool,
}
...
History_Type_0025 :: struct {
	...
	width: int,
	height: int,
	tradition: History_Type_0026,
	parcels: [24]History_Type_0024,
	parcel_count: int,
	garden_x: int,
	garden_z: int,
	garden_span: int,
...
History_Type_0031 :: struct {
	forward: History_Type_0036,
	up: History_Type_0036,
	right: History_Type_0036,
}

// fixture-history-id: adriatic:packages/flight.Body_State
History_Type_0032 :: struct {
	position: History_Type_0036,
	velocity: History_Type_0036,
	angular_velocity_world: History_Type_0036,
...
History_Type_0039 :: struct {
	position: History_Type_0060,
	yaw: f32,
	class: History_Type_0012,
	kind: History_Type_0040,
	occupied: bool,
...
History_Type_0041 :: struct {
	minimum: History_Type_0060,
	maximum: History_Type_0060,
}
...
History_Type_0045 :: struct {
	...
	valid: bool,
	downgraded: bool,
	strategy: History_Type_0050,
	program: History_Type_0047,
	site: History_Type_0049,
	phases: [5]History_Type_0051,
	phase_count: int,
	waterfront_zones: [12]History_Type_0062,
	waterfront_count: int,
	runtime_plan: History_Type_0046,
...
History_Type_0046 :: struct {
	...
	archetype: History_Type_0038,
	valid: bool,
	bounds: History_Type_0041,
	origin: History_Type_0060,
	tangent: History_Type_0060,
	outward: History_Type_0060,
	sea_level: f32,
	shoreline: History_Type_0043,
	navigable_water: History_Type_0043,
	fairway: History_Type_0043,
	turning_basin: History_Type_0043,
	structures: [24]History_Type_0057,
	structure_count: int,
	berths: [128]History_Type_0039,
	berth_count: int,
	routes: [128]History_Type_0053,
	route_count: int,
	terrain_edits: [32]History_Type_0058,
	terrain_edit_count: int,
	office: History_Type_0060,
	settlement_connection: History_Type_0060,
	entrance: History_Type_0060,
	diagnostics: History_Type_0044,
}

// fixture-history-id: adriatic:packages/harbor.Harbor_Program
History_Type_0047 :: struct {
	role: History_Type_0054,
	purpose: History_Type_0048,
	population: int,
	target_capacity: int,
...
History_Type_0057 :: struct {
	kind: History_Type_0055,
	material: History_Type_0056,
	width: f32,
	points: [12]History_Type_0060,
	count: int,
}

// fixture-history-id: adriatic:packages/harbor.Terrain_Edit
History_Type_0058 :: struct {
	kind: History_Type_0059,
	center: History_Type_0060,
	radius: f32,
	target_y: f32,
	feather: f32,
}
...
History_Type_0062 :: struct {
	use: History_Type_0061,
	center: History_Type_0060,
	width: f32,
	depth: f32,
	landward: History_Type_0060,
}

// fixture-history-id: adriatic:packages/libellula.Runtime
History_Type_0063 :: struct {
	body: History_Type_0032,
	vehicle: History_Type_0141,
	airframe: History_Type_0034,
	flight_runtime: History_Type_0035,
	tuning: History_Type_0064,
	spawn_position: History_Type_0036,
	spawn_orientation: quaternion128,
	throttle: f32,
	pitch: f32,
	roll: f32,
	yaw: f32,
	rotor_turns: History_Type_0036,
	grounded: bool,
	was_grounded: bool,
	crashed: bool,
	lift_active: bool,
...
History_Type_0069 :: struct {
	seed: u32,
	layout_seed: u32,
	candidate_index: int,
	candidates_evaluated: int,
	style: History_Type_0065,
	boundary_form: History_Type_0067,
	shoreline_form: History_Type_0075,
	section_form_counts: [9]int,
	cells: [567]History_Type_0068,
	segments: [96]History_Type_0073,
	segment_count: int,
	slips: [40]History_Type_0076,
	slip_count: int,
	props: [48]History_Type_0070,
	prop_count: int,
	route: History_Type_0072,
	office: History_Type_0077,
	world_conditioned: bool,
	world_origin: History_Type_0077,
	world_yaw: f32,
	spacing_density: f32,
...
History_Type_0070 :: struct {
	kind: History_Type_0071,
	position: History_Type_0077,
	yaw: f32,
}

// fixture-history-id: adriatic:packages/marina.Prop_Kind
History_Type_0071 :: enum u8 {
	Lamp = 0,
	Beacon = 1,
	Bollard = 2,
	Crates = 3,
...
History_Type_0072 :: struct {
	points: [8]History_Type_0077,
	count: int,
}

// fixture-history-id: adriatic:packages/marina.Segment
History_Type_0073 :: struct {
	kind: History_Type_0074,
	a: History_Type_0077,
	b: History_Type_0077,
	width: f32,
}
...
History_Type_0076 :: struct {
	position: History_Type_0077,
	yaw: f32,
	class: History_Type_0012,
	occupied: bool,
	kind: History_Type_0066,
}
...
History_Type_0080 :: struct {
	position: History_Type_0082,
	velocity: History_Type_0082,
	life: f32,
	max_life: f32,
	size: f32,
	seed: u32,
...
History_Type_0081 :: struct {
	particles: [192]History_Type_0080,
	count: int,
	spawn: f32,
	seed: u32,
}
...
History_Type_0086 :: struct {
	particles: [192]History_Type_0085,
	count: int,
	spawn: f32,
	seed: u32,
}
...
History_Type_0091 :: struct {
	body: History_Type_0032,
	vehicle: History_Type_0141,
	airframe: History_Type_0030,
	flight_runtime: History_Type_0033,
	flight_model: History_Type_0088,
	ace_tuning: History_Type_0029,
	ace_runtime: History_Type_0028,
	throttle: f32,
	flap_fraction: f32,
	propeller_turns: f32,
	pitch: f32,
	...
	last_landing: History_Type_0089,
	landing_feedback_seconds: f32,
	landing_intent_seconds: f32,
	landing_intent: bool,
	spawn_position: History_Type_0036,
	spawn_orientation: quaternion128,
	tuning: History_Type_0092,
}
...
History_Type_0096 :: struct {
	from: int,
	to: int,
	control_from: History_Type_0100,
	control_to: History_Type_0100,
	half_width: f32,
	shoulder_width: f32,
	pavement: History_Type_0099,
	use_intensity: f32,
}

// fixture-history-id: adriatic:packages/roads.Graph
History_Type_0097 :: struct {
	nodes: [64]History_Type_0098,
	node_count: int,
	edges: [128]History_Type_0096,
	edge_count: int,
}

// fixture-history-id: adriatic:packages/roads.Node
History_Type_0098 :: struct {
	position: History_Type_0100,
	up: History_Type_0100,
	junction_radius: f32,
}

// fixture-history-id: adriatic:packages/roads.Pavement
History_Type_0099 :: enum u8 {
	Asphalt = 0,
	Gravel = 1,
	Cobblestone = 2,
	Dirt = 3,
...
History_Type_0100 :: [3]f32

// fixture-history-id: adriatic:packages/rondine.Runtime
History_Type_0101 :: struct {
	body: History_Type_0032,
	vehicle: History_Type_0141,
	tuning: History_Type_0103,
	telemetry: History_Type_0102,
	spawn_position: History_Type_0036,
	spawn_basis: History_Type_0031,
	throttle: f32,
	propeller_turns: f32,
	steering: f32,
	target_height: f32,
...
History_Type_0107 :: struct {
	active: bool,
	kind: History_Type_0108,
	from: History_Type_0111,
	to: History_Type_0111,
	origin: History_Type_0109,
	destination: History_Type_0109,
	subject: string,
	care: History_Type_0106,
}
...
History_Type_0113 :: struct {
	quest: History_Type_0094,
	romance: History_Type_0112,
	repair: History_Type_0110,
	airfield_errand: History_Type_0105,
	delivery: History_Type_0107,
...
History_Type_0117 :: struct {
	card: History_Type_0114,
	orientation: History_Type_0116,
	position: string,
}
...
History_Type_0123 :: struct {
	...
	rotation: f32,
	color: [4]u8,
	kind: History_Type_0121,
	entrance_side: History_Type_0120,
	seed: u32,
	building: History_Type_0018,
}
...
History_Type_0126 :: struct {
	position: History_Type_0131,
	target: History_Type_0131,
}
...
History_Type_0128 :: struct {
	poses: [3]History_Type_0126,
	active: History_Type_0127,
}
...
History_Type_0130 :: struct {
	position: History_Type_0131,
	velocity: History_Type_0131,
	facing_yaw_radians: f32,
	grounded: bool,
	turn_amount: f32,
	brake_amount: f32,
	ground_normal: History_Type_0131,
	running: bool,
	drifting: bool,
	drift_charge: f32,
	boost_seconds: f32,
...
History_Type_0134 :: struct {
	kind: History_Type_0133,
	name: string,
	available: bool,
}
...
History_Type_0137 :: struct {
	velocity: History_Type_0131,
	yaw_rate: f32,
	reaction_force: History_Type_0131,
	body_roll: f32,
	body_pitch: f32,
	wheel_rotation: f32,
}
...
History_Type_0143 :: struct {
	editor_camera: History_Type_0125,
	editor_focus: History_Type_0131,
	player_camera: History_Type_0125,
...
Fixture :: struct {
	project: History_Type_0122,
	authoring_tool: History_Type_0142,
	editor_ui: History_Type_0145,
	tool: History_Type_0124,
	radius: f32,
	strength: f32,
	hardness: f32,
	structure_selected: int,
	structure_kind: History_Type_0121,
	...
	architecture_brush_shape: History_Type_0169,
	architecture_brush_preset: History_Type_0168,
	architecture_brush_strength: f32,
	architecture_brush_hardness: f32,
	marina_paint_mode: bool,
	marina_authored: bool,
	marina_authored_plan: History_Type_0069,
	harbor_authored_plan: History_Type_0046,
	harbor_authored_intervention: History_Type_0045,
	marina_brush_radius: f32,
	farm_paint_mode: bool,
	farm_brush_radius: f32,
	farms: [16]History_Type_0146,
	farm_count: int,
	farm_brush_yaw: f32,
	wreck_paint_mode: bool,
	wreck_brush_size: f32,
	wreck_brush_yaw: f32,
	wrecks: [8]History_Type_0202,
	wreck_count: int,
	default_marinas: [2]History_Type_0069,
	default_harbors: [2]History_Type_0046,
	default_marina_islands: [2]History_Type_0109,
	...
	road_pavement: History_Type_0099,
	in_map: bool,
	player: History_Type_0130,
	...
	camera: History_Type_0125,
	camera_pose: History_Type_0126,
	cameras: History_Type_0128,
	flight_camera: History_Type_0022,
	editor_camera: History_Type_0125,
	editor_focus: History_Type_0131,
	boat_traffic: History_Type_0014,
	marina_dinghy_borrowed: bool,
	occupant: History_Type_0139,
	pilot: History_Type_0138,
	car: History_Type_0141,
	car_drive: History_Type_0135,
	car_trailer: History_Type_0137,
	car_trailer_attached: bool,
	car_trailer_position: History_Type_0131,
	car_trailer_yaw: f32,
	postale: History_Type_0091,
	libellula: History_Type_0063,
	rondine: History_Type_0101,
	aircraft: History_Type_0132,
	...
	settlement_plan: History_Type_0181,
	...
	vehicle_paint_tool: History_Type_0198,
	vehicle_paint_component: int,
	vehicle_paint_component_mask: [5]bool,
	vehicle_paint_saved_postale_position: History_Type_0036,
	vehicle_paint_saved_libellula_position: History_Type_0036,
	...
	attendant_position: History_Type_0131,
	gerta_position: History_Type_0131,
	story_state: History_Type_0113,
	player_mail: History_Type_0087,
	tracked_quest_node: History_Type_0093,
	quest_tracking_suppressed: bool,
	quest_tracking_revision: u64,
	atmosphere: History_Type_0005,
	vehicle_effects: History_Type_0083,
	wing_trails: History_Type_0086,
	petal_effects: History_Type_0081,
	tweak: History_Type_0197,
	default_map_regeneration_seeds: [2]u32,
	mouse_fur: History_Type_0154,
	mouse_pattern: History_Type_0155,
	mouse_headgear: History_Type_0153,
	mouse_scarf_enabled: bool,
	mouse_scarf_color: History_Type_0203,
...
History_Type_0158 :: struct {
	cpu_seed: u32,
	vehicle_seed: u32,
	wing_seed: u32,
	cpu: History_Type_0156,
	vehicle: History_Type_0159,
	wing: History_Type_0160,
	gpu: History_Type_0157,
}

// fixture-history-id: adriatic:src.Particle_Vehicle_Tweak
History_Type_0159 :: struct {
	dust_spawn_rate: f32,
...
History_Type_0173 :: struct {
	kind: History_Type_0174,
	age: f32,
	order: int,
...
History_Type_0177 :: struct {
	route_length: History_Type_0189,
	route_width: History_Type_0189,
	route_grade: History_Type_0189,
	route_length_by_class: [8]History_Type_0189,
	route_width_by_class: [8]History_Type_0189,
	intersection_spacing: History_Type_0189,
	dead_end_frontage: History_Type_0189,
	block_short_side: History_Type_0189,
	block_long_side: History_Type_0189,
	block_area: History_Type_0189,
	block_aspect: History_Type_0189,
	block_irregularity: History_Type_0189,
	parcel_frontage: History_Type_0189,
	parcel_depth: History_Type_0189,
	building_height: History_Type_0189,
	building_footprint: History_Type_0189,
	building_floors: History_Type_0189,
	network_density: f32,
	road_badness: f32,
	attached_share: f32,
...
History_Type_0179 :: struct {
	...
	seed: u32,
	host_id: u64,
	style: History_Type_0180,
}

// fixture-history-id: adriatic:src.Settlement_Patio_Style
History_Type_0180 :: enum u8 {
	Adriatic = 0,
	Aegean = 1,
}

// fixture-history-id: adriatic:src.Settlement_Plan
History_Type_0181 :: struct {
	request: History_Type_0186,
	brush_pieces: [64]History_Type_0167,
	brush_piece_count: int,
	next_brush_component_id: u32,
	program: History_Type_0183,
	activity_points: [512]History_Type_0165,
	activity_point_count: int,
	inhabitants: [256]History_Type_0175,
	inhabitant_count: int,
	village_reason: History_Type_0200,
	neighborhoods: [96]History_Type_0178,
	neighborhood_count: int,
	macro_cells: [192]History_Type_0178,
	macro_cell_count: int,
	routes: [320]History_Type_0182,
	...
	growth_events: [96]History_Type_0173,
	growth_event_count: int,
	blocks: [128]History_Type_0166,
	block_count: int,
	sites: [256]History_Type_0191,
	site_piece_ids: [256]u32,
	site_count: int,
	gardens: [64]History_Type_0171,
	garden_count: int,
	patios: [48]History_Type_0179,
	patio_count: int,
	rejected_sites: [32]History_Type_0191,
	rejected_site_count: int,
	decorative_foliage: [32]History_Type_0123,
	decorative_foliage_count: int,
	terrain_edits: [192]History_Type_0193,
	terrain_edit_count: int,
	ordinary_purposes: [256]History_Type_0170,
	ordinary_purpose_count: int,
	metrics: History_Type_0177,
	acceptance_failure: History_Type_0163,
	valid: bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0182 :: struct {
	geometry: History_Type_0187,
	class: History_Type_0188,
	width: f32,
	shoulder: f32,
	pavement: History_Type_0099,
	required: bool,
...
History_Type_0183 :: struct {
	ordinary: History_Type_0184,
	purposes: [8]History_Type_0184,
	landmarks: History_Type_0184,
	plazas: History_Type_0184,
	parks: History_Type_0184,
	vegetation: History_Type_0184,
	residents: History_Type_0184,
	workers: History_Type_0184,
...
History_Type_0186 :: struct {
	region: History_Type_0185,
	scale: History_Type_0190,
	seed: u32,
	center: [2]f32,
	radius: f32,
	density: f32,
...
History_Type_0191 :: struct {
	structure: History_Type_0123,
	parcel: History_Type_0003,
	kind: History_Type_0192,
	tissue: History_Type_0195,
	density: f32,
	attached: bool,
	accepted: bool,
	landmark_kind: History_Type_0176,
	purpose: History_Type_0170,
	fountain_style: History_Type_0037,
	fountain_radius: f32,
...
History_Type_0193 :: struct {
	kind: History_Type_0194,
	center: [2]f32,
	half_extent: [2]f32,
	target_height: f32,
	feather: f32,
...
History_Type_0197 :: struct {
	terrain: History_Type_0196,
	atmosphere: History_Type_0005,
	player: History_Type_0129,
	player_animation: History_Type_0161,
	player_tail: History_Type_0078,
	camera: History_Type_0143,
	world: History_Type_0201,
	particles: History_Type_0158,
	car: History_Type_0136,
	car_vehicle: History_Type_0199,
	postale_airframe: History_Type_0030,
	postale_runtime: History_Type_0033,
	postale_tuning: History_Type_0092,
	postale_vehicle: History_Type_0199,
	presentation: History_Type_0162,
}

// fixture-history-id: adriatic:src.Vehicle_Paint_Tool
History_Type_0198 :: enum u8 {
	Brush = 0,
	Bucket = 1,
	Shape = 2,
	Blend = 3,
...
History_Type_0202 :: struct {
	cells: [31]History_Type_0149,
	seed: u32,
	form: History_Type_0150,
	break_index: int,
	second_break_index: int,
	part_count: int,
	first_bay: int,
	last_bay: int,
	parts: [3]History_Type_0151,
	quality: History_Type_0152,
	origin_x: f32,
	origin_z: f32,
	yaw: f32,
	scale: f32,
...
History_Type_0203 :: History_Type_0204
