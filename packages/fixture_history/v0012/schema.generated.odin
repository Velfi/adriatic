...
// fixture-history-schema-version: 12
// fixture-history-manifest-sha256: 396030c727d26c8817343bd7a6b163970ff50cb7c5c2ed7767f6cbcb27091e31
package fixture_v0012
...
History_Type_0004 :: struct {
    structures:   [dynamic]History_Type_0125,
    count:        int,
...
History_Type_0024 :: struct {
    pose:                     History_Type_0128,
    base_pose:                History_Type_0128,
    orbit_yaw:                f32,
    orbit_pitch:              f32,
    focal_length:             f32,
    shake_phase:              f32,
...
History_Type_0088 :: struct {
    particles: [192]History_Type_0087,
    count:     int,
    spawn:     f32,
    seed:      u32,
}
...
History_Type_0125 :: struct {
    ...
    rotation:      f32,
    color:         [4]u8,
    kind:          History_Type_0123,
    entrance_side: History_Type_0122,
    seed:          u32,
...
History_Type_0128 :: struct {
    position: History_Type_0133,
    target:   History_Type_0133,
}

// fixture-history-id: adriatic:packages/third_person.Camera_Slot
History_Type_0129 :: enum u8 {
    Player     = 0,
    Inspection = 1,
    Cutaway    = 2,
    Count      = 3,
...
History_Type_0130 :: struct {
    poses:  [3]History_Type_0128,
    active: History_Type_0129,
}
...
History_Type_0132 :: struct {
    position:           History_Type_0133,
    velocity:           History_Type_0133,
    facing_yaw_radians: f32,
    grounded:           bool,
    turn_amount:        f32,
    brake_amount:       f32,
    ground_normal:      History_Type_0133,
    running:            bool,
    drifting:           bool,
    drift_charge:       f32,
    boost_seconds:      f32,
...
History_Type_0139 :: struct {
    velocity:       History_Type_0133,
    yaw_rate:       f32,
    reaction_force: History_Type_0133,
    body_roll:      f32,
    body_pitch:     f32,
    wheel_rotation: f32,
}
...
History_Type_0145 :: struct {
    editor_camera:      History_Type_0127,
    editor_focus:       History_Type_0133,
    player_camera:      History_Type_0127,
...
Fixture :: struct {
    project:                                History_Type_0124,
    authoring_tool:                         History_Type_0144,
    editor_ui:                              History_Type_0147,
    tool:                                   History_Type_0126,
    radius:                                 f32,
    strength:                               f32,
    hardness:                               f32,
    structure_selected:                     int,
    structure_kind:                         History_Type_0123,
    ...
    architecture_brush_shape:               History_Type_0171,
    architecture_brush_preset:              History_Type_0170,
    ...
    farms:                                  [16]History_Type_0148,
    farm_count:                             int,
    farm_brush_yaw:                         f32,
    wreck_paint_mode:                       bool,
    wreck_brush_size:                       f32,
    wreck_brush_yaw:                        f32,
    wrecks:                                 [8]History_Type_0204,
    wreck_count:                            int,
    ...
    camera:                                 History_Type_0127,
    camera_pose:                            History_Type_0128,
    cameras:                                History_Type_0130,
    flight_camera:                          History_Type_0024,
    editor_camera:                          History_Type_0127,
    editor_focus:                           History_Type_0133,
    boat_traffic:                           History_Type_0016,
    marina_dinghy_borrowed:                 bool,
    occupant:                               History_Type_0141,
    pilot:                                  History_Type_0140,
    car:                                    History_Type_0143,
    car_drive:                              History_Type_0137,
    car_trailer:                            History_Type_0139,
    car_trailer_attached:                   bool,
    car_trailer_position:                   History_Type_0133,
    car_trailer_yaw:                        f32,
    postale:                                History_Type_0093,
    libellula:                              History_Type_0065,
    rondine:                                History_Type_0103,
    aircraft:                               History_Type_0134,
    ...
    settlement_plan:                        History_Type_0183,
    ...
    vehicle_paint_tool:                     History_Type_0200,
    ...
    attendant_position:                     History_Type_0133,
    gerta_position:                         History_Type_0133,
    ...
    tweak:                                  History_Type_0199,
    default_map_regeneration_seeds:         [2]u32,
    mouse_fur:                              History_Type_0156,
    mouse_pattern:                          History_Type_0157,
    mouse_headgear:                         History_Type_0155,
    mouse_scarf_enabled:                    bool,
    mouse_scarf_color:                      History_Type_0205,
...
History_Type_0160 :: struct {
    ...
    vehicle_seed: u32,
    wing_seed:    u32,
    cpu:          History_Type_0158,
    vehicle:      History_Type_0161,
    wing:         History_Type_0162,
    gpu:          History_Type_0159,
}
...
History_Type_0179 :: struct {
    route_length:               History_Type_0191,
    route_width:                History_Type_0191,
    route_grade:                History_Type_0191,
    route_length_by_class:      [8]History_Type_0191,
    route_width_by_class:       [8]History_Type_0191,
    intersection_spacing:       History_Type_0191,
    dead_end_frontage:          History_Type_0191,
    block_short_side:           History_Type_0191,
    block_long_side:            History_Type_0191,
    block_area:                 History_Type_0191,
    block_aspect:               History_Type_0191,
    block_irregularity:         History_Type_0191,
    parcel_frontage:            History_Type_0191,
    parcel_depth:               History_Type_0191,
    building_height:            History_Type_0191,
    building_footprint:         History_Type_0191,
    building_floors:            History_Type_0191,
    network_density:            f32,
    road_badness:               f32,
    attached_share:             f32,
...
History_Type_0183 :: struct {
    request:                      History_Type_0188,
    brush_pieces:                 [64]History_Type_0169,
    brush_piece_count:            int,
    next_brush_component_id:      u32,
    program:                      History_Type_0185,
    activity_points:              [512]History_Type_0167,
    activity_point_count:         int,
    inhabitants:                  [256]History_Type_0177,
    inhabitant_count:             int,
    village_reason:               History_Type_0202,
    neighborhoods:                [96]History_Type_0180,
    neighborhood_count:           int,
    macro_cells:                  [192]History_Type_0180,
    macro_cell_count:             int,
    routes:                       [320]History_Type_0184,
    ...
    growth_events:                [96]History_Type_0175,
    growth_event_count:           int,
    blocks:                       [128]History_Type_0168,
    block_count:                  int,
    sites:                        [256]History_Type_0193,
    site_piece_ids:               [256]u32,
    site_count:                   int,
    gardens:                      [64]History_Type_0173,
    garden_count:                 int,
    patios:                       [48]History_Type_0181,
    patio_count:                  int,
    rejected_sites:               [32]History_Type_0193,
    rejected_site_count:          int,
    decorative_foliage:           [32]History_Type_0125,
    decorative_foliage_count:     int,
    terrain_edits:                [192]History_Type_0195,
    terrain_edit_count:           int,
    ordinary_purposes:            [256]History_Type_0172,
    ordinary_purpose_count:       int,
    metrics:                      History_Type_0179,
    acceptance_failure:           History_Type_0165,
    valid:                        bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0184 :: struct {
    geometry:      History_Type_0189,
    class:         History_Type_0190,
    width:         f32,
    shoulder:      f32,
    pavement:      History_Type_0101,
    required:      bool,
...
History_Type_0185 :: struct {
    ordinary:             History_Type_0186,
    purposes:             [8]History_Type_0186,
    landmarks:            History_Type_0186,
    plazas:               History_Type_0186,
    parks:                History_Type_0186,
    vegetation:           History_Type_0186,
    residents:            History_Type_0186,
    workers:              History_Type_0186,
...
History_Type_0188 :: struct {
    region:  History_Type_0187,
    scale:   History_Type_0192,
    seed:    u32,
    center:  [2]f32,
    radius:  f32,
    density: f32,
...
History_Type_0193 :: struct {
    ...
    attached:            bool,
    accepted:            bool,
    landmark_kind:       History_Type_0178,
    purpose:             History_Type_0172,
...
History_Type_0199 :: struct {
    terrain:          History_Type_0198,
    atmosphere:       History_Type_0005,
    player:           History_Type_0131,
    player_animation: History_Type_0163,
    player_tail:      History_Type_0080,
    camera:           History_Type_0145,
    world:            History_Type_0203,
    particles:        History_Type_0160,
    car:              History_Type_0138,
    car_vehicle:      History_Type_0201,
    postale_airframe: History_Type_0032,
    postale_runtime:  History_Type_0035,
    postale_tuning:   History_Type_0094,
    postale_vehicle:  History_Type_0201,
    presentation:     History_Type_0164,
}
...
History_Type_0204 :: struct {
    cells:              [31]History_Type_0151,
    seed:               u32,
    form:               History_Type_0152,
    break_index:        int,
    second_break_index: int,
    part_count:         int,
    first_bay:          int,
    last_bay:           int,
    parts:              [3]History_Type_0153,
    quality:            History_Type_0154,
    origin_x:           f32,
    origin_z:           f32,
    yaw:                f32,
    scale:              f32,
...
History_Type_0205 :: History_Type_0206
