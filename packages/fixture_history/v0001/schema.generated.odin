...
// fixture-history-schema-version: 1
// fixture-history-manifest-sha256: 2f29187e4a2587e9c6319e953a9801232d67cdaefb308435f74b2cc53a4abd12
package fixture_v0001
...
History_Type_0003 :: struct {
    structures:   [256]History_Type_0082,
    count:        int,
    parcels:      [256]History_Type_0002,
    parcel_count: int,
    alleys:       [128]History_Type_0000,
    alley_count:  int,
    lamps:        [256]History_Type_0001,
    lamp_count:   int,
}
...
History_Type_0019 :: struct {
    pose:                     History_Type_0085,
    base_pose:                History_Type_0085,
    orbit_yaw:                f32,
    orbit_pitch:              f32,
    focal_length:             f32,
    shake_phase:              f32,
    shake_intensity:          f32,
    previous_target_position: History_Type_0031,
    initialized:              bool,
}
...
History_Type_0024 :: struct {
    forward: History_Type_0031,
    up:      History_Type_0031,
    right:   History_Type_0031,
}

// fixture-history-id: adriatic:packages/flight.Body_State
History_Type_0025 :: struct {
    position:         History_Type_0031,
    velocity:         History_Type_0031,
    angular_velocity: History_Type_0031,
    basis:            History_Type_0024,
}
...
History_Type_0030 :: struct {
    rotor_thrusts:        History_Type_0031,
    rotor_rpm_normalized: History_Type_0031,
    total_thrust:         f32,
}

// fixture-history-id: adriatic:packages/flight.Vec3
History_Type_0031 :: [3]f32

// fixture-history-id: adriatic:packages/libellula.Runtime
History_Type_0032 :: struct {
    body:           History_Type_0025,
    vehicle:        History_Type_0099,
    airframe:       History_Type_0028,
    flight_runtime: History_Type_0029,
    telemetry:      History_Type_0030,
    tuning:         History_Type_0033,
    spawn_position: History_Type_0031,
    spawn_basis:    History_Type_0024,
    throttle:       f32,
    pitch:          f32,
    roll:           f32,
    yaw:            f32,
    rotor_turns:    History_Type_0031,
    grounded:       bool,
    was_grounded:   bool,
    crashed:        bool,
    lift_active:    bool,
...
History_Type_0038 :: struct {
    seed:                      u32,
    layout_seed:               u32,
    candidate_index:           int,
    candidates_evaluated:      int,
    style:                     History_Type_0034,
    boundary_form:             History_Type_0036,
    shoreline_form:            History_Type_0044,
    section_form_counts:       [9]int,
    cells:                     [567]History_Type_0037,
    segments:                  [96]History_Type_0042,
    segment_count:             int,
    slips:                     [40]History_Type_0045,
    slip_count:                int,
    props:                     [48]History_Type_0039,
    prop_count:                int,
    route:                     History_Type_0041,
    office:                    History_Type_0046,
    world_conditioned:         bool,
    world_origin:              History_Type_0046,
    world_yaw:                 f32,
    spacing_density:           f32,
...
History_Type_0048 :: struct {
    position: History_Type_0090,
    previous: History_Type_0090,
}

// fixture-history-id: adriatic:packages/mouse_tail.State
History_Type_0049 :: struct {
    points:      [13]History_Type_0048,
    last_root:   History_Type_0090,
    initialized: bool,
}
...
History_Type_0060 :: struct {
    body:                     History_Type_0025,
    vehicle:                  History_Type_0099,
    airframe:                 History_Type_0023,
    flight_runtime:           History_Type_0026,
    telemetry:                History_Type_0027,
    throttle:                 f32,
    flap_fraction:            f32,
    propeller_turns:          f32,
    pitch:                    f32,
...
History_Type_0062 :: struct {
    from:           int,
    to:             int,
    control_from:   History_Type_0066,
    control_to:     History_Type_0066,
    half_width:     f32,
    shoulder_width: f32,
    pavement:       History_Type_0065,
}

// fixture-history-id: adriatic:packages/roads.Graph
History_Type_0063 :: struct {
    nodes:      [64]History_Type_0064,
    node_count: int,
    edges:      [128]History_Type_0062,
    edge_count: int,
}

// fixture-history-id: adriatic:packages/roads.Node
History_Type_0064 :: struct {
    position:        History_Type_0066,
    up:              History_Type_0066,
    junction_radius: f32,
}
...
History_Type_0073 :: struct {
    romance:              History_Type_0072,
    repair:               History_Type_0070,
    delivery:             History_Type_0067,
...
History_Type_0077 :: struct {
    card:        History_Type_0074,
    orientation: History_Type_0076,
    position:    string,
}
...
History_Type_0081 :: struct {
    levels:                [6]History_Type_0079,
    sea_level:             f32,
    revision:              u64,
    structures:            [256]History_Type_0082,
    structure_count:       int,
    next_structure_id:     u64,
    road_graph:            History_Type_0063,
...
History_Type_0087 :: struct {
    poses:  [3]History_Type_0085,
    active: History_Type_0086,
}
...
History_Type_0089 :: struct {
    position:           History_Type_0090,
    velocity:           History_Type_0090,
    facing_yaw_radians: f32,
    grounded:           bool,
    turn_amount:        f32,
    brake_amount:       f32,
    ground_normal:      History_Type_0090,
    running:            bool,
    drifting:           bool,
    drift_charge:       f32,
    boost_seconds:      f32,
...
History_Type_0096 :: struct {
    velocity:       History_Type_0090,
    yaw_rate:       f32,
    reaction_force: History_Type_0090,
    body_roll:      f32,
    body_pitch:     f32,
    wheel_rotation: f32,
}
...
History_Type_0101 :: struct {
    editor_camera:      History_Type_0084,
    editor_focus:       History_Type_0090,
    player_camera:      History_Type_0084,
...
Fixture :: struct {
    project:                                History_Type_0081,
    authoring_tool:                         History_Type_0100,
    editor_ui:                              History_Type_0103,
    tool:                                   History_Type_0083,
    radius:                                 f32,
    strength:                               f32,
    hardness:                               f32,
    structure_selected:                     int,
    structure_kind:                         History_Type_0080,
    ...
    marina_authored_plan:                   History_Type_0038,
    marina_brush_radius:                    f32,
    farm_paint_mode:                        bool,
    farm_brush_radius:                      f32,
    farms:                                  [16]History_Type_0104,
    farm_count:                             int,
    ...
    road_pavement:                          History_Type_0065,
    in_map:                                 bool,
    player:                                 History_Type_0089,
    ...
    camera:                                 History_Type_0084,
    camera_pose:                            History_Type_0085,
    cameras:                                History_Type_0087,
    flight_camera:                          History_Type_0019,
    editor_camera:                          History_Type_0084,
    editor_focus:                           History_Type_0090,
    boat_traffic:                           History_Type_0011,
    marina_dinghy_borrowed:                 bool,
    pilot:                                  History_Type_0097,
    car:                                    History_Type_0099,
    car_drive:                              History_Type_0094,
    car_trailer:                            History_Type_0096,
    car_trailer_attached:                   bool,
    car_trailer_position:                   History_Type_0090,
    car_trailer_yaw:                        f32,
    postale:                                History_Type_0060,
    libellula:                              History_Type_0032,
    aircraft:                               History_Type_0091,
    ...
    settlement_plan:                        History_Type_0123,
    ...
    vehicle_paint_tool:                     History_Type_0138,
    vehicle_paint_component:                int,
    vehicle_paint_component_mask:           [5]bool,
    vehicle_paint_saved_postale_position:   History_Type_0031,
    vehicle_paint_saved_libellula_position: History_Type_0031,
    ...
    attendant_position:                     History_Type_0090,
    gerta_position:                         History_Type_0090,
    story_state:                            History_Type_0073,
    ...
    tweak:                                  History_Type_0137,
    mouse_fur:                              History_Type_0108,
    mouse_pattern:                          History_Type_0109,
    mouse_headgear:                         History_Type_0107,
    mouse_scarf_enabled:                    bool,
    mouse_scarf_color:                      History_Type_0142,
...
History_Type_0112 :: struct {
    ...
    vehicle_seed: u32,
    wing_seed:    u32,
    cpu:          History_Type_0110,
    vehicle:      History_Type_0113,
    wing:         History_Type_0114,
    gpu:          History_Type_0111,
}
...
History_Type_0121 :: struct {
    route_length:          History_Type_0129,
    route_width:           History_Type_0129,
    route_grade:           History_Type_0129,
    route_length_by_class: [8]History_Type_0129,
    route_width_by_class:  [8]History_Type_0129,
    intersection_spacing:  History_Type_0129,
    block_short_side:      History_Type_0129,
    block_long_side:       History_Type_0129,
    block_area:            History_Type_0129,
    block_aspect:          History_Type_0129,
    block_irregularity:    History_Type_0129,
    parcel_frontage:       History_Type_0129,
    parcel_depth:          History_Type_0129,
    building_height:       History_Type_0129,
    building_footprint:    History_Type_0129,
    building_floors:       History_Type_0129,
    network_density:       f32,
    attached_share:        f32,
...
History_Type_0123 :: struct {
    request:                  History_Type_0126,
    village_reason:           History_Type_0140,
    neighborhoods:            [96]History_Type_0122,
    neighborhood_count:       int,
    macro_cells:              [192]History_Type_0122,
    macro_cell_count:         int,
    routes:                   [48]History_Type_0124,
    route_count:              int,
    blocks:                   [128]History_Type_0118,
    block_count:              int,
    sites:                    [256]History_Type_0131,
    site_count:               int,
    rejected_sites:           [32]History_Type_0131,
    rejected_site_count:      int,
    decorative_foliage:       [32]History_Type_0082,
    decorative_foliage_count: int,
    terrain_edits:            [192]History_Type_0133,
    terrain_edit_count:       int,
    city_plan:                History_Type_0003,
    ordinary_purposes:        [256]History_Type_0119,
    ordinary_purpose_count:   int,
    metrics:                  History_Type_0121,
    acceptance_failure:       History_Type_0117,
    valid:                    bool,
}

// fixture-history-id: adriatic:src.Settlement_Planned_Route
History_Type_0124 :: struct {
    geometry:      History_Type_0127,
    class:         History_Type_0128,
    width:         f32,
    shoulder:      f32,
    pavement:      History_Type_0065,
    required:      bool,
...
History_Type_0126 :: struct {
    region: History_Type_0125,
    scale:  History_Type_0130,
    seed:   u32,
    center: [2]f32,
    radius: f32,
}
...
History_Type_0131 :: struct {
    ...
    attached:      bool,
    accepted:      bool,
    landmark_kind: History_Type_0120,
    purpose:       History_Type_0119,
}
...
History_Type_0137 :: struct {
    terrain:          History_Type_0136,
    atmosphere:       History_Type_0004,
    player:           History_Type_0088,
    player_animation: History_Type_0115,
    player_tail:      History_Type_0047,
    camera:           History_Type_0101,
    world:            History_Type_0141,
    particles:        History_Type_0112,
    car:              History_Type_0095,
    car_vehicle:      History_Type_0139,
    postale_airframe: History_Type_0023,
    postale_runtime:  History_Type_0026,
    postale_tuning:   History_Type_0061,
    postale_vehicle:  History_Type_0139,
    presentation:     History_Type_0116,
}
...
History_Type_0142 :: History_Type_0143
