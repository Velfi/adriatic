...
init_quest_catalog :: proc(catalog: ^Quest_Catalog) {
    ...
    catalog.nodes = {
        ...
        },
        {
            ...
            title = "Return Iva's acceptance to Niko",
            instruction = "Bring Iva's answer to Niko beneath the blue regatta awning.",
            location = "West island bakery",
            kind = .Objective,
        ...
        },
        {
            ...
            instruction = "Visit Niko and Iva after Iva's arrival for the regatta.",
