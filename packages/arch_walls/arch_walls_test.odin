...
curved_wall_scales_with_length_and_follows_both_terrain_edges :: proc(t: ^testing.T) {
    ...
    short := Path {
        point_count = 2,
    }; short.points[0] = {0, 0}; short.points[1] = {10, 0}
    long := Path {
        point_count = 4,
    }; long.points[0] = {0, 0}; long.points[1] = {10, 3}; long.points[2] = {20, -3}; long.points[3] = {40, 0}
...
arches_repeat_along_complete_spline :: proc(t: ^testing.T) {
    ...
    path := Path {
        point_count = 3,
    }; path.points[0] = {0, 0}; path.points[1] = {18, 6}; path.points[2] = {36, 0}
