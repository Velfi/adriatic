...
FIXTURE_MIGRATION_V0015_TO_V0016_RESOLUTIONS :: [?]Fixture_Migration_Resolution {
    Fixture_Migration_Resolution{change_id = "field-add:adriatic:src.Fixture.note_count", kind = .Scripted},
    Fixture_Migration_Resolution{change_id = "field-add:adriatic:src.Fixture.notes", kind = .Scripted},
}
