...
fixture_migration_v0021_to_v0022_preserves_existing_formation_kind :: proc(t: ^testing.T) {
    ...
    testing.expect(t, registry.steps[len(registry.steps) - 3].from_version == 21)
    testing.expect(t, registry.steps[len(registry.steps) - 3].to_version == 22)
    testing.expect(t, registry.steps[len(registry.steps) - 3].wrapper == fixture_migration_step_v0021_to_v0022)
