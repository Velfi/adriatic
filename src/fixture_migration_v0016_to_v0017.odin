...
FIXTURE_MIGRATION_V0016_TO_V0017_RESOLUTIONS :: [?]Fixture_Migration_Resolution {
    ...
    Fixture_Migration_Resolution{change_id = "field-add:adriatic:packages/roads.Edge.curvature_to", kind = .Scripted},
    Fixture_Migration_Resolution{change_id = "field-add:adriatic:packages/roads.Edge.design_id", kind = .Scripted},
    Fixture_Migration_Resolution {
    ...
    Fixture_Migration_Resolution{change_id = "field-add:adriatic:packages/roads.Edge.station_from", kind = .Scripted},
    Fixture_Migration_Resolution{change_id = "field-add:adriatic:packages/roads.Edge.station_to", kind = .Scripted},
    Fixture_Migration_Resolution {
