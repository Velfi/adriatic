...
fixture_migration_step_v0020_to_v0021 :: proc(
    ...
    if step_context == nil ||
       ...
       step_context.source_version > 20 ||
       step_context.step_from_version != FIXTURE_MIGRATION_V0020_TO_V0021_FROM_VERSION ||
       step_context.step_to_version != FIXTURE_MIGRATION_V0020_TO_V0021_TO_VERSION ||
    ...
    return fixture_migrate_v0020_to_v0021(
        fixture_v0020.Fixture{},
