...
test-rondine: doctor $(DEV_DIR)/libadriatic_mesh.a
	$(ODIN) test packages/rondine $(ZELDA_ENGINE_COLLECTION) $(ODIN_VET_FLAGS) -extra-linker-flags:"$(call link_flags,$(DEV_DIR))"
...
fixture-migration-v0015-to-v0016-test: doctor $(PHYSICS_STAMP) $(TEXTSHAPE_LIB) $(DEV_DIR)/libadriatic_mesh.a $(DEV_DIR)/libgfx_signposts.a
	$(ODIN) test src $(ZELDA_ENGINE_COLLECTION) $(ODIN_VET_FLAGS) -define:ODIN_TEST_THREADS=1 -define:ODIN_TEST_NAMES=main.fixture_migration_v0015_to_v0016_initializes_empty_notes,main.fixture_v0016_note_count_validation_rejects_invalid_bounds -extra-linker-flags:"$(TEXTSHAPE_LIBS) -L$(abspath $(DEV_DIR)) -lgfx_signposts -lc++"
